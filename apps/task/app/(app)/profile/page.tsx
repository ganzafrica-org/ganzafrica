...
export default function ProfilePage(): React.JSX.Element {
  ...
  const uploadImage = async (file: File): Promise<string | null> => {
    try {
      ...
      const response = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL || "http://localhost:3002/api"}/uploads/file`,
        {
          method: "POST",
          body: formData,
  ...
  if (loading) {
    return (
      <PageLayout members={[]} tasks={[]} title="My Profile" className="bg-gray-50">
          ...
          <div className="bg-white shadow-sm" style={{ borderRadius: "7px" }}>
            <div className="p-6">
              <div className="flex items-start justify-between mb-6">
                ...
                <Button onClick={() => setIsEditing(!isEditing)} variant="outline" icon={Edit3}>
              ...
              {isEditing && (
                <div className="flex gap-3 mt-6">
                  ...
                  <Button onClick={handleCancel} variant="outline" icon={X} disabled={saving}>
                    Cancel
                  </Button>
                </div>
              )}
              ...
              <div className="space-y-6">
                {userData.preferences?.notifications ? (
                  Object.entries(userData.preferences.notifications).map(([key, value]) => (
                    <div
                      key={key}
                      className="flex items-center justify-between py-3 border-b border-gray-400 last:border-b-0"
                    >
                      <div>
                      ...
                      <label className="relative inline-flex items-center cursor-pointer">
                        <input
                          ...
                          checked={value || false}
                          onChange={(e) =>
                            handleInputChange(`preferences.notifications.${key}`, e.target.checked)
                          }
                          ...
                          style={
                            {
                              ...
                              backgroundColor: value ? "#076297" : "#e5e7eb",
          ...
          <div className="bg-white rounded-lg p-6 w-96 max-w-md mx-4">
            ...
            <div className="space-y-4">
              <p className="text-sm text-gray-600">
                ...
                need to use an authenticator app to generate verification codes.
              </p>
            ...
            <div className="flex gap-3 mt-6">
              ...
              <Button onClick={() => setShow2FA(false)} variant="outline">
                Cancel
              </Button>
            </div>
          </div>
      ...
      {showSessions && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 w-96 max-w-md mx-4">
            ...
            <div className="flex gap-3 mt-6">
              <Button onClick={() => setShowSessions(false)} variant="outline">
                Close
              </Button>
            </div>
          </div>
