            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center justify-between py-3">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  ...
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all" style={{ '--tw-ring-color': '#076297', backgroundColor: settings.autoSave ? '#076297' : '#e5e7eb' } as React.CSSProperties}></div>
                </label>
              </div>
              ...
              <div className="flex items-center justify-between py-3">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    onChange={(e) => handleSettingChange('display.sidebarCollapsed', e.target.checked)}
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all" style={{ '--tw-ring-color': '#076297', backgroundColor: settings.display.sidebarCollapsed ? '#076297' : '#e5e7eb' } as React.CSSProperties}></div>
                </label>
              </div>
              ...
              <div className="flex items-center justify-between py-3">
                ...
                <label className="relative inline-flex items-center cursor-pointer">
                  <input
                    ...
                    className="sr-only peer"
                  />
                  <div className="w-11 h-6 bg-gray-200 peer-focus:outline-none peer-focus:ring-4 rounded-full peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all" style={{ '--tw-ring-color': '#076297', backgroundColor: settings.display.showCompletedTasks ? '#076297' : '#e5e7eb' } as React.CSSProperties}></div>
                </label>
              </div>
            </div>
          </div>
