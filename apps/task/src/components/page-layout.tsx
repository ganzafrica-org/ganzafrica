      ...
      >
        ...
        <aside 
          ...
          style={{ 
            ...
            WebkitOverflowScrolling: 'touch',
            WebkitTransform: 'translateZ(0)',
            transform: mobileOpen ? 'translateX(0) translateZ(0)' : 'translateX(-100%) translateZ(0)',
            overflowY: 'auto',
            overflowX: 'hidden',
        ...
        >
          <div className="p-3 sm:p-4 md:p-5 lg:p-6 xl:p-8 pb-6 sm:pb-8 md:pb-10" style={{ overflowX: 'hidden', width: '100%' }}>
