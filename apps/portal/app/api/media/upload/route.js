...
export async function POST(req) {
    try {
        ...
        try {
            ...
            return NextResponse.json({ success: false, error: 'Error processing file' }, { status: 500 });
        }
        ...
        try {
            ...
            return NextResponse.json({ success: false, error: 'Server configuration error - contact administrator' }, { status: 500 });
        }
        // Save the file
        try {
            ...
            return NextResponse.json({ success: false, error: 'Error saving file to disk' }, { status: 500 });
        }
    }
    catch (error) {
