...
export default function AuthLayout({ children, }) {
    return (<div className="relative h-screen w-full overflow-hidden bg-[#f0f4f3]">
      <div className="absolute top-0 right-0 h-96 w-96 -translate-y-10 translate-x-10 transform bg-blue" style={{
