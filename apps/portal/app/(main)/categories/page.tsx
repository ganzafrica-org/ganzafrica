        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {filteredCategories.map((category) => (
            <Card key={category.id} className="relative overflow-hidden">
              <div
                className={`absolute left-0 top-0 bottom-0 w-1 ${category.color ? category.color.split(" ")[0] : "bg-emerald-100"}`}
              />
              <CardHeader className="pb-3">
                <div className="flex justify-between items-start">
                  <div>
                  ...
                  <Badge className={category.color || "bg-emerald-100 text-emerald-800"}>
                    Project
                  </Badge>
                </div>
              </CardHeader>
      ...
      <Dialog open={isEditDialogOpen} onOpenChange={setIsEditDialogOpen}>
        <DialogContent>
          <DialogHeader>
            ...
            <DialogDescription>Update this project category's information.</DialogDescription>
          </DialogHeader>
          <div className="space-y-4 py-4">
            <div className="space-y-2">
