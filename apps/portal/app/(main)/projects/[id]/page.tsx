            ...
            <img
              ...
              onError={(e) => {
                ...
                (e.target as HTMLImageElement).src =
                  "/api/placeholder/400/300?text=Image+Not+Available";
              }}
            />
          </div>
        ) : media.type === "video" ? (
          ...
          <ul>
              ...
              >
                ...
                <div className="ml-4">
                  ...
                  <p className="text-sm text-gray-500">
                    The overview, vision, progress of the project
                  </p>
                </div>
              </button>
            </li>
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "team" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
            ...
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "documents" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
            ...
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "partners" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
                  ...
                  (project.media.items.find((item) => item.tag === "feature" || item.cover) ? (
                    <img
                      ...
                      onError={(e) => {
                        // Fallback to placeholder on error
                        (e.target as HTMLImageElement).src =
                          "/api/placeholder/800/400?text=Image+Not+Available";
                      }}
                    />
                  ) : (
                      ...
                      >
                        <div className="flex items-start mb-2">
                          <div className="mr-2 mt-1">
                            <CheckCircle
                              className={`w-4 h-4 ${goal.completed ? "text-green-600" : "text-gray-400"}`}
                            />
                          </div>
                        ...
                        <div className="flex justify-between items-start mb-2">
                          ...
                          <span
                            className={`text-xs px-2 py-1 rounded ${
                              outcome.status === "completed" || outcome.status === "achieved"
              ...
              {project.partners && project.partners.length > 0 ? (
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  {project.partners.map((partner) => {
                    ...
                    return (
                      <div key={partnerKey} className="flex items-center p-4 bg-gray-50 rounded-lg">
                          ...
                          {partnerLogo ? (
                            <img
                              ...
                              onError={(e) => {
                                ...
                                e.currentTarget.parentElement!.innerHTML = `<div class="flex items-center justify-center w-full h-full">
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {project.media.items
                        ...
                        .map(renderMediaItem)}
                      {project.media.items.filter((item) => item.tag === "feature").length ===
                        0 && (
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {project.media.items
                        ...
                        .map(renderMediaItem)}
                      {project.media.items.filter((item) => item.tag === "description").length ===
                        0 && (
                        <div className="p-4 bg-gray-50 rounded-lg text-gray-500 text-center col-span-full">
                  ...
                  <div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                      {project.media.items
                        .filter(
                          (item) =>
                            item.tag === "others" || !["feature", "description"].includes(item.tag),
                        )
                        .map(renderMediaItem)}
                      {project.media.items.filter(
                        (item) =>
                          item.tag === "others" || !["feature", "description"].includes(item.tag),
                      ).length === 0 && (
                        <div className="p-4 bg-gray-50 rounded-lg text-gray-500 text-center col-span-full">
