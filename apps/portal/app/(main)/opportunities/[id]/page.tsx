...
const OpportunityDetailsPage = ({ params }) => {
  ...
  const getApplicationStatusBadge = (status) => {
    ...
    switch (status.toLowerCase()) {
      ...
      case "shortlisted":
        return (
          <span className="px-2 py-1 text-xs font-medium rounded-full bg-blue-100 text-blue-800 flex items-center inline-flex">
            <CheckCircle className="w-3 h-3 mr-1" />
            Shortlisted
          </span>
        );
      case "waitlisted":
        return (
          <span className="px-2 py-1 text-xs font-medium rounded-full bg-purple-100 text-purple-800 flex items-center inline-flex">
            <Clock className="w-3 h-3 mr-1" />
            Waitlisted
          </span>
        );
      ...
      <div className="flex justify-between items-center mb-6">
        <div>
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">{getStatusBadge(opportunity.status)}</div>
          </div>
      ...
      <div className="flex flex-col md:flex-row gap-6">
          ...
          <ul>
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "details" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
            ...
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "eligibility" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
            ...
            {opportunity.type === "fellowship" && opportunity.fellowship_details && (
              <li className="mb-6">
                ...
                >
                  <div className="flex-shrink-0 mt-1">
                    <div
                      className={`w-3 h-3 rounded-full ${activeTab === "program" ? "bg-green-700" : "bg-gray-300"}`}
                    ></div>
                  </div>
                  <div className="ml-4">
            ...
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "application" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
            ...
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "applicants" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
        ...
        <div className="w-full md:w-3/4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                      <div>
                        ...
                        <p className="font-medium">
                          {opportunity.fellowship_details.program_name || "N/A"}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500 mb-1">Cohort</p>
                        <p className="font-medium">
                          {opportunity.fellowship_details.cohort || "N/A"}
                        </p>
                      </div>
                      <div>
                        <p className="text-sm text-gray-500 mb-1">Fellowship Type</p>
                        <p className="font-medium capitalize">
                          {opportunity.fellowship_details.fellowship_type || "N/A"}
                        </p>
                      </div>
                    </div>
                  </div>
          ...
          {activeTab === "program" &&
            ...
            opportunity.fellowship_details && (
              <div className="bg-white p-6 rounded-lg border border-gray-200">
              ...
              {opportunity.custom_questions && opportunity.custom_questions.length > 0 ? (
                <div className="space-y-6">
                  <p className="text-gray-700 mb-4">
                    Below are the custom questions that applicants will need to answer when applying
                ...
                <div className="flex items-center justify-between mt-6">
                  <div className="text-sm text-gray-700">
                    ...
                    <span className="font-medium">
                      {applicants.length > 0 ? (page - 1) * limit + 1 : 0}
                    </span>{" "}
                    to{" "}
                    <span className="font-medium">{Math.min(page * limit, totalApplicants)}</span>{" "}
                    of <span className="font-medium">{totalApplicants}</span> applicants
                  </div>
