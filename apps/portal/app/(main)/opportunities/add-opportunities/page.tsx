...
const CreateOpportunityForm = () => {
  ...
  const removePhase = (index: number) => {
    const updatedPhases = formData.fellowship_details.program_structure.phases.filter(
      (_, i) => i !== index,
    );
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Failed to create opportunity. Please try again.",
      );
    } finally {
      setIsLoading(false);
    }
        ...
        <div className="mb-8">
          <div className="flex">
            ...
            <div className="w-3/4">
              {/* Countries */}
              <div className="mb-6">
                <label className="block text-sm font-medium mb-1">Eligible Countries</label>
                <MultipleSelector
              ...
              <div className="mb-6">
                ...
                <MultipleSelector
                  ...
                  emptyIndicator={
                    <p className="text-center text-lg leading-10 text-gray-600">No skills added.</p>
                  }
                />
              </div>
                    ...
                    <div className="mt-4 border-t border-gray-200 pt-4">
                        ...
                        <div className="mb-3 space-y-2">
                          {(question.options || []).map((option, optionIndex) => (
                            <div key={optionIndex} className="flex items-center">
                              <span className="flex-1 text-sm bg-gray-100 p-2 rounded-md">
                                {option}
                              </span>
                              <button
                                type="button"
                      ...
                      <div className="flex">
                        <input
                          ...
                          onChange={(e) =>
                            setNewQuestionOption({ ...newQuestionOption, [index]: e.target.value })
                          }
          ...
          <div className="mb-8">
            <div className="flex">
              ...
              <div className="w-3/4">
                      ...
                      <div className="grid grid-cols-2 gap-4 mb-2">
                        ...
                        <div>
                          ...
                          <input
                            ...
                            onChange={(e) =>
                              handlePhaseChange(index, "duration_weeks", e.target.value)
                            }
                            min="0"
                            className="w-full p-2 border border-gray-300 rounded-md text-sm"
                            placeholder="0"
                ...
                {/* Activities */}
                <div className="mb-6">
                  <label className="block text-sm font-medium mb-1">Program Activities</label>
                  <MultipleSelector
