            ...
            <div className="w-full md:w-3/4">
                ...
                <div className="flex items-center">
                  <button
                    ...
                    className={`text-sm py-1 px-3 rounded-md ${
                      useMediaUrl ? "bg-green-700 text-white" : "bg-gray-200 text-gray-700"
                    }`}
                  >
                    Use URL
                  </button>
                        ...
                        {newMedia.type === "image" && (
                          <div className="mb-4 border rounded overflow-hidden">
                            <img
                              ...
                              onLoad={() =>
                                console.log(`Successfully loaded image: ${newMedia.url}`)
                              }
                              onError={(e) => {
                                ...
                                const fallbackText =
                                  newMedia.title?.charAt(0)?.toUpperCase() || "N";
                  ...
                  {!newMedia.file ? (
                    <div className="flex flex-col items-center justify-center">
                      ...
                      <p className="text-xs text-gray-400">
                        Supports images (JPEG, PNG, GIF, WEBP) and videos (MP4, WEBM, MOV) up to
                        10MB
                      </p>
                    </div>
                  ) : (
              ...
              {formData.media.items.length === 0 ? (
                <p className="text-gray-500 text-sm italic mb-4">
                  No media added yet. Upload images or videos to enhance your article.
                </p>
              ) : (
