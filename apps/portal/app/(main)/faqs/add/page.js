        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="space-y-4">
            ...
            <div>
              ...
              <Input id="question" placeholder="Enter the question" value={formData.question} onChange={(e) => setFormData({ ...formData, question: e.target.value })}/>
            </div>
            ...
            <div>
              ...
              <Textarea id="answer" placeholder="Enter the detailed answer" className="min-h-[200px]" value={formData.answer} onChange={(e) => setFormData({ ...formData, answer: e.target.value })}/>
            </div>
          </div>
