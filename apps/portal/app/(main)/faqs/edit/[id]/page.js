...
export default function EditFAQPage() {
    ...
    if (isLoading) {
        return (<div className="p-6 max-w-4xl mx-auto">
                <div className="mb-6">
                    <Button variant="ghost" className="mb-4 opacity-50 pointer-events-none">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
                <div className="space-y-4">
                    <div>
                        ...
                        <Input id="question" placeholder="Enter the question" value={formData.question} onChange={(e) => setFormData({ ...formData, question: e.target.value })} required/>
                    </div>
                    ...
                    <div>
                        ...
                        <Textarea id="answer" placeholder="Enter the detailed answer" className="min-h-[200px]" value={formData.answer} onChange={(e) => setFormData({ ...formData, answer: e.target.value })} required/>
                    </div>
                    ...
                    {formData.view_count > 0 && (<div className="mt-4 p-4 bg-gray-50 rounded-lg">
                ...
                <div className="flex justify-end gap-4">
                    ...
                    <Button type="submit" className="bg-primary-green hover:bg-green-700" disabled={isSubmitting}>
