...
const UserManagement = () => {
  ...
  const downloadTemplate = () => {
    const csvContent =
      "email,name,password,role_id,avatar_url,email_verified\nexample@example.com,John Doe,password123,1001,,false";
            ...
            <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
              ...
              <div className="flex items-center gap-2">
                <Select
                  ...
                  onValueChange={(value) =>
                    setSelectedRoleId(value === "all" ? null : parseInt(value))
                  }
                >
      ...
      >
        <DialogContent className="sm:max-w-md">
            ...
            <DialogDescription className="text-base">
              <div className="bg-red-50 rounded-lg p-4 mt-2">
                <p className="font-semibold text-red-600 mb-2">
                  ⚠️ Warning: This is a dangerous action!
                </p>
          ...
          <DialogFooter>
            ...
            <Button onClick={handleDeleteUser} disabled={isDeleting} variant="destructive">
              {isDeleting ? (
                <>
                  <Loader className="h-4 w-4 mr-2 animate-spin" />
                  Deleting...
