...
import { Upload, Check, Plus, Loader, Search, Filter, MoreVertical, Download } from 'lucide-react';
        ...
        <header className="bg-white border-b border-gray-200">
          <div className="flex items-center justify-between px-6 py-4">
            ...
            <div className="flex items-center space-x-4">
              <Button variant="outline" className="flex items-center gap-2" onClick={() => setShowImportDialog(true)}>
                <Upload className="h-4 w-4"/>
                Import users
              </Button>

              <Button className="flex bg-primary-green items-center gap-2" onClick={() => setShowAddUserDialog(true)}>
        ...
        <main className="p-6">
          <Card>
            ...
            <CardContent className="p-4 border-b border-gray-200">
              <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
                <div className="relative w-full sm:max-w-md">
                  ...
                  <Input type="text" placeholder="Search users..." className="w-full pl-10" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)}/>
                </div>
                <div className="flex items-center gap-2">
                <Select value={selectedRoleId === null ? "all" : selectedRoleId.toString()} onValueChange={(value) => setSelectedRoleId(value === "all" ? null : parseInt(value))}>
            ...
            return (<PaginationItem key={page}>
                  ...
                  <PaginationItem>
                    <PaginationNext onClick={() => setCurrentPage(prev => Math.min(pagination.pages, prev + 1))} disabled={currentPage === pagination.pages}/>
                  </PaginationItem>
                </PaginationContent>
              </Pagination>
            </CardFooter>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                <FormField control={form.control} name="role_id" render={({ field }) => (<FormItem>
                ...
                <FormField control={form.control} name="email_verified" render={({ field }) => (<FormItem className="flex items-center space-x-2 space-y-0">
                          <FormControl>
                            <input type="checkbox" className="form-checkbox h-4 w-4 text-primary rounded" checked={field.value} onChange={field.onChange}/>
                          </FormControl>
                          <FormLabel className="m-0">Email verified</FormLabel>
                        </FormItem>)}/>

                {!editingUser && (<FormField control={form.control} name="sendVerificationEmail" render={({ field }) => (<FormItem className="flex items-center space-x-2 space-y-0">
                              <FormControl>
                                <input type="checkbox" className="form-checkbox h-4 w-4 text-primary rounded" checked={field.value} onChange={field.onChange}/>
                              </FormControl>
          ...
          <DialogContent className="sm:max-w-md">
            ...
            <Tabs defaultValue="upload" className="w-full">
              ...
              <TabsContent value="upload" className="py-4">
                <div className="space-y-4">
                  ...
                  <div className="border-2 border-dashed rounded-lg p-6 text-center">
                    <input type="file" id="csv-upload" accept=".csv" className="hidden" ref={fileInputRef} onChange={handleFileChange}/>
                  ...
                  {importData.length > 0 && (<div className="text-sm text-center text-muted-foreground">
              ...
              <TabsContent value="preview" className="h-[250px] overflow-auto">
                {importData.length === 0 ? (<div className="flex flex-col items-center justify-center h-full text-center text-muted-foreground">
                      ...
                      <TableBody>
                        {importData.slice(0, 5).map((user, index) => (<TableRow key={index}>
            ...
            setImportData([]);
              ...
              <Button onClick={handleImportUsers} disabled={isImporting || importData.length === 0} className="bg-primary-green">
                  {isImporting ? (<>
