  ...
  return (
    <div className="p-8 bg-gray-50 dark:bg-gray-900">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-600 dark:text-gray-400">Here's an overview of your dashboard activities and statistics today.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <Card className="relative shadow-sm overflow-hidden dark:bg-gray-800">
          ...
          <div className="absolute top-4 right-4">
            <div className="rounded-full p-2 bg-light-orange dark:bg-orange-900">
              <FolderGit2 className="w-5 h-5 text-primary-orange" />
            </div>
          </div>
          <CardHeader>
            <CardDescription className="text-gray-600 dark:text-gray-400">Total Projects</CardDescription>
            <CardTitle className="text-2xl font-semibold mt-2 dark:text-white">123</CardTitle>
          </CardHeader>
          <CardFooter className="flex items-center pt-0 pb-5">
            <div className="flex items-center">
        ...
        <Card className="relative shadow-sm overflow-hidden dark:bg-gray-800">
          ...
          <div className="absolute top-4 right-4">
            <div className="rounded-full p-2 bg-blue-lighter dark:bg-blue-900">
              <Briefcase className="w-5 h-5 text-blue" />
            </div>
          </div>
          <CardHeader>
            <CardDescription className="text-gray-600 dark:text-gray-400">Total Opportunities</CardDescription>
            <CardTitle className="text-2xl font-semibold mt-2 dark:text-white">123</CardTitle>
          </CardHeader>
          <CardFooter className="flex items-center pt-0 pb-5">
            <div className="flex items-center">
        ...
        <Card className="relative shadow-sm overflow-hidden dark:bg-gray-800">
          ...
          <div className="absolute top-4 right-4">
            <div className="rounded-full p-2 bg-yellow-lighter dark:bg-yellow-900">
              <FileText className="w-5 h-5 text-orange-grid" />
            </div>
          </div>
          <CardHeader>
            <CardDescription className="text-gray-600 dark:text-gray-400">All News</CardDescription>
            <CardTitle className="text-2xl font-semibold mt-2 dark:text-white">123</CardTitle>
          </CardHeader>
          <CardFooter className="flex items-center pt-0 pb-5">
            <div className="flex items-center">
        ...
        <Card className="shadow-sm dark:bg-gray-800">
          ...
          <CardFooter className="flex justify-center items-center pt-0">
            <div className="flex items-center space-x-2">
              ...
              <span className="dark:text-gray-300">Application track</span>
            </div>
          </CardFooter>
        </Card>
      </div>
      ...
      <div className="grid grid-cols-12 gap-6">
        ...
        <div className="col-span-12 lg:col-span-8 bg-white dark:bg-gray-800 rounded-lg">
          <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-4 flex justify-between items-center">
            <h2 className="text-lg font-semibold dark:text-white">Recent Activities</h2>
          </div>
          ...
          {recentActivities.map((activity, index) => (
            <div key={index} className="flex items-start px-4 py-4">
              ...
              <div className={`pb-4 ${index < recentActivities.length - 1 ? "border-b dark:border-gray-700" : ""}`}>
        ...
        <div className="col-span-12 lg:col-span-4 bg-white dark:bg-gray-800 rounded-lg">
          <div className="border-b border-gray-200 dark:border-gray-700 px-4 py-4 flex justify-between items-center">
            <h2 className="text-lg font-semibold dark:text-white">Active Projects</h2>
            <a href="#" className="text-emerald-600 dark:text-emerald-400 hover:underline">View all Projects</a>
          </div>
          ...
          {activeProjects.map((project, index) => (
            <div key={index} className="flex items-start px-4 py-4">
              ...
              <div className={`pb-4 ${index < activeProjects.length - 1 ? "border-b dark:border-gray-700" : ""}`}>
