...
import { ArrowLeft, Upload, X, Plus, AlertCircle, Loader, ChevronDown, Save, Check, Mail, Globe, User, Briefcase, Tag, Image, LinkIcon } from 'lucide-react';
    ...
    return (<div className="max-w-7xl mx-auto p-6">
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md">
        ...
        <div className="mb-6">
                    ...
                    {/* URL preview */}
                    {formData.photo_url && (<div className="mt-4 p-4 bg-gray-50 rounded-md">
                        <div className="flex items-center mb-3">
                          <Image className="w-6 h-6 mr-2 text-blue-500"/>
                          <span className="text-sm font-medium">Image from URL</span>
                        </div>
                        <div className="mb-4 border rounded overflow-hidden">
                          <img src={formData.photo_url} alt="Profile preview" className="w-full h-auto max-h-60 object-contain" onError={(e) => {
        ...
        <>
                ...
                {!usePhotoUrl && formData.photo_url && (<div className="p-4 bg-gray-50 rounded-md mb-6">
                    <div className="flex items-center mb-3">
                      <Image className="w-6 h-6 mr-2 text-blue-500"/>
                    ...
                    {/* Image preview */}
                    <div className="mb-4 border rounded overflow-hidden">
                      <img src={formData.photo_url} alt="Profile preview" className="w-full h-auto max-h-60 object-contain"/>
                    </div>
