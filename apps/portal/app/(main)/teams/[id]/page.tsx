          ...
          <ul>
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "profile" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
            ...
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "skills" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
            ...
            <li className="mb-6">
              ...
              >
                <div className="flex-shrink-0 mt-1">
                  <div
                    className={`w-3 h-3 rounded-full ${activeTab === "bio" ? "bg-green-700" : "bg-gray-300"}`}
                  ></div>
                </div>
                <div className="ml-4">
