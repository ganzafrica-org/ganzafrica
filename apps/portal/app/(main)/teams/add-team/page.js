...
import { ArrowLeft, Upload, X, Plus, AlertCircle, Loader, ChevronDown, UserPlus, Check, Mail, Globe, User, Briefcase, Tag, Image, LinkIcon } from 'lucide-react';
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-lg shadow-md">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="name" value={formData.name} onChange={handleChange} className="w-full pl-10 p-2.5 border border-gray-300 rounded-md" placeholder="Enter full name" required/>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="text" name="position" value={formData.position} onChange={handleChange} className="w-full pl-10 p-2.5 border border-gray-300 rounded-md" placeholder="Enter position or role" required/>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="email" name="email" value={formData.email} onChange={handleChange} className="w-full pl-10 p-2.5 border border-gray-300 rounded-md" placeholder="Enter email address" required/>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <select name="team_type_id" value={formData.team_type_id} onChange={handleChange} className="w-full pl-10 p-2.5 border border-gray-300 rounded-md appearance-none" required>
                      <option value="">Select a team type</option>
                      {teamTypes.map(type => (<option key={type.id} value={type.id}>
                          {type.name}
                        </option>))}
                    </select>
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <input type="url" name="profile_link" value={formData.profile_link} onChange={handleChange} className="w-full pl-10 p-2.5 border border-gray-300 rounded-md" placeholder="LinkedIn or other profile URL"/>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="flex">
            ...
            <div className="w-3/4">
              <div className="mb-4">
                ...
                <textarea name="bio" value={formData.bio} onChange={handleChange} rows={5} className="w-full p-2.5 border border-gray-300 rounded-md" placeholder="Enter professional background, experience, and achievements..."/>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="flex">
            ...
            <div className="w-3/4">
              ...
              <div className="mb-4">
                ...
                {formData.skills.length > 0 ? (<div className="flex flex-wrap gap-2 mb-4">
                    {formData.skills.map((skill, index) => (<div key={index} className="bg-gray-100 rounded-full px-3 py-1 text-sm flex items-center">
                        <span className="mr-1">{skill}</span>
                        <button type="button" onClick={() => removeSkill(skill)} className="text-gray-500 hover:text-red-500">
                          <X className="w-4 h-4"/>
                        </button>
                      </div>))}
                  </div>) : (<p className="text-gray-500 text-sm italic mb-4">No skills added yet.</p>)}
                
                {/* Add skill form */}
                <div className="flex space-x-2">
                  <input type="text" value={newSkill} onChange={(e) => setNewSkill(e.target.value)} onKeyPress={handleSkillKeyPress} placeholder="Add a skill" className="w-full p-2.5 border border-gray-300 rounded-md"/>
                  <button type="button" onClick={addSkill} className="bg-gray-100 hover:bg-gray-200 text-gray-800 py-2 px-4 rounded-md flex items-center">
            ...
            <div className="w-3/4">
              <div className="mb-4">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="flex items-center mb-2">
                    <button type="button" onClick={togglePhotoUrlMode} className={`text-sm py-1 px-3 rounded-md ${usePhotoUrl
        ...
        <div className="mb-6">
                    <div className="relative">
                      ...
                      <input type="url" value={formData.photo_url} onChange={handlePhotoUrlChange} className="w-full pl-10 p-2.5 border border-gray-300 rounded-md" placeholder="Enter image URL (https://...)"/>
                    </div>
                    
                    {/* URL preview */}
                    {formData.photo_url && !formData.photo_url.startsWith('blob:') && (<div className="mt-4 p-4 bg-gray-50 rounded-md">
                        <div className="flex items-center mb-3">
                          <Image className="w-6 h-6 mr-2 text-blue-500"/>
                          <span className="text-sm font-medium">Image from URL</span>
                        </div>
                        <div className="mb-4 border rounded overflow-hidden">
                          <img src={formData.photo_url} alt="Profile preview" className="w-full h-auto max-h-60 object-contain" onLoad={() => console.log(`Successfully loaded image: ${formData.photo_url}`)} onError={(e) => {
                    ...
                    handleImageError(e, fallbackText);
                        ...
                        <button type="button" onClick={() => setFormData(prev => ({ ...prev, photo_url: '' }))} className="text-sm text-red-500 hover:text-red-700 flex items-center">
        ...
        <>
                    {/* Upload area */}
                    <div className="border-2 border-dashed border-gray-300 p-6 rounded-md text-center mb-6 cursor-pointer" onClick={!photoFile ? triggerFileInput : undefined}>
                      {!photoFile ? (<div className="flex flex-col items-center justify-center">
                          ...
                          {photoFile && (<div className="text-xs text-gray-500 mb-4">
                          ...
                          {/* Image preview */}
                          <div className="mb-4 border rounded overflow-hidden">
                            <img src={formData.photo_url} alt="Profile preview" className="w-full h-auto max-h-60 object-contain" onLoad={() => console.log(`Successfully loaded image preview: ${formData.photo_url}`)} onError={(e) => {
                    ...
                    {photoFile && (<div className="flex justify-between">
                    ...
                    if (fileInputRef.current) {
                        ...
                        <button type="button" onClick={triggerFileInput} className="text-sm text-blue-500 hover:text-blue-700 flex items-center">
        ...
        <div className="flex justify-end space-x-3 p-6 border-t border-gray-200">
          <button type="button" className="px-6 py-2 border border-gray-300 rounded-md text-gray-700 hover:bg-gray-50" onClick={() => router.push('/teams')}>
            Cancel
          </button>
