...
import { ArrowLeft, ArrowRight, Play, Circle } from 'lucide-react';
    ...
    return (<div className="min-h-screen bg-white">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <Image src="/images/fellowship/hands-seeds.jpg" alt="Seeds in hands" fill className="object-cover"/>
            </div>
            <div>
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative h-[400px] rounded-lg overflow-hidden">
              <Image src="/images/fellowship/team.jpg" alt="Fellowship team" fill className="object-cover"/>
              <div className="absolute inset-0 flex items-center justify-center">
                <button className="w-16 h-16 rounded-full text-primary-orange flex items-center justify-center" title="Play video">
      ...
      <section className="py-16">
        <div className="container mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {benefits.map((benefit, index) => (<Card key={index} className="overflow-hidden">
        ...
        <div className="container mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              {promises.map((promise) => (<div key={promise.number} className="flex gap-6">
      ...
      <section className="py-16 bg-gray-50">
        <div className="container mx-auto px-6">
          ...
          <div className="flex justify-center space-x-4 mb-12">
            {[1, 2, 3, 4, 5].map((i) => (<div key={i} className="w-16 h-16 rounded-full overflow-hidden">
                <Image src={i === 3 ? "/images/fellowship/nla.jpg" : `/images/fellowship/avatar-${i}.jpg`} alt="Fellow" width={64} height={64} className="object-cover"/>
              </div>))}
          </div>
          ...
          <div className="max-w-3xl mx-auto text-center">
            ...
            <div className="flex justify-center space-x-4">
              <button onClick={prevTestimonial} className="w-12 h-12 rounded-full text-primary-orange flex items-center justify-center" title="Previous testimonial">
                <ArrowLeft className="text-white"/>
              </button>
              <button onClick={nextTestimonial} className="w-12 h-12 rounded-full bg-[#045F3C] flex items-center justify-center" title="Next testimonial">
