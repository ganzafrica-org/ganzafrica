...
export default function EntryPage() {
    ...
    useEffect(() => {
        ...
        const timer = setInterval(() => {
            const currentStep = loadingSteps.find(step => step.progress > progress && step.progress <= 100);
            if (currentStep) {
    ...
    return (<div className="flex items-center justify-center min-h-screen bg-white">
            <div className="text-center w-full max-w-md px-4">
                <Image src="/logo.png" alt="Ganz Africa Logo" width={200} height={200} className="mx-auto mb-6" priority/>
