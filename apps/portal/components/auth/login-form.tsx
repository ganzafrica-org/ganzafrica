  ...
  const handleLogin = async (data: { email: string; password: string }) => {
    ...
    try {
      ...
      if (
        ...
        showErrorToast({
          message:
            "You don't have an account with that email. Please create an account and try to login later.",
        });
      } else {
            ...
            <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-5">
              <div className="mb-4">
                ...
                <div className="relative">
                  <div
                    className={`absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none ${loginError || loginForm.formState.errors.email || loginForm.formState.errors.password ? "text-red-600" : "text-black"}`}
                  >
