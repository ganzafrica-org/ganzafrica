...
export function LoginForm() {
    ...
    if (requiresTwoFactor) {
        return (<Card className="w-full max-w-md mx-auto p-6 shadow-lg rounded-lg">
                ...
                <Form {...totpForm}>
                    <form onSubmit={totpForm.handleSubmit(handleVerify)} className="space-y-6">
                        <FormField control={totpForm.control} name="totpCode" render={({ field }) => (<FormItem className="mx-auto flex flex-col items-center space-y-2">
                                    <FormControl>
                        ...
                        <Button type="submit" className="w-full text-white bg-primary-green" disabled={isLoading}>
    ...
    return (<div className="flex overflow-hidden rounded-lg shadow-xl mx-auto max-w-4xl">
            ...
            <div className="w-1/2 bg-primary-green text-white p-8 flex flex-col items-center justify-center">
                <div className="mb-6">
                    <Image src="/images/logoLight.png" alt="Logo" width={100} height={30} className="object-contain" priority/>
                </div>
            ...
            <div className="w-2/3 bg-white p-8">
                <div className="max-w-md mx-auto">
                    ...
                    <div className="flex justify-center space-x-4 mb-6">
                        ...
                        {['facebook', 'google', 'linkedin'].map((provider) => (<button key={provider} className="w-8 h-8 rounded-full bg-gray-100 flex items-center justify-center" aria-label={`Login with ${provider}`}>
                                {/* Add SVG for each social provider */}
                                {provider === 'facebook' && (<svg width="16" height="16" viewBox="0 0 24 24" fill="#000">
                                        <path d="M9.198 21.5h4v-8.01h3.604l.396-3.98h-4V7.5a1 1 0 0 1 1-1h3v-4h-3a5 5 0 0 0-5 5v2.01h-2l-.396 3.98h2.396v8.01z"/>
                                    </svg>)}
                                {provider === 'google' && (<svg width="16" height="16" viewBox="0 0 24 24" fill="#000">
                                ...
                                {provider === 'linkedin' && (<svg width="16" height="16" viewBox="0 0 24 24" fill="#000">
                        ...
                        <form onSubmit={loginForm.handleSubmit(handleLogin)} className="space-y-5">
                            <div className="mb-4">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="email" placeholder="email@example.com" className="pl-10 py-2 block w-full border border-gray-200 rounded" {...loginForm.register('email', {
        ...
        pattern: {
            ...
            message: 'Invalid email address'
                                ...
                                {loginForm.formState.errors.email && (<p className="text-red-500 text-sm mt-1">
                            ...
                            <div className="mb-4">
                                ...
                                <div className="relative">
                                    ...
                                    <input type="password" placeholder="••••••••" className="pl-10 py-2 block w-full border border-gray-200 rounded" {...loginForm.register('password', {
        ...
        minLength: {
            ...
            message: 'Password must be at least 8 characters'
                                ...
                                {loginForm.formState.errors.password && (<p className="text-red-500 text-sm mt-1">
                            ...
                            <Button type="submit" className="w-full py-2 rounded-md text-white bg-primary-green" disabled={isLoading}>
