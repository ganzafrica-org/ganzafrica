      ...
      <div className="flex items-center space-x-2">
        ...
        {user ? (
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div
                className="relative w-8 h-8 rounded-full overflow-hidden bg-primary-green text-white flex items-center justify-center"
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 z-50 border border-gray-100 dark:border-gray-700">
                <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                  <div className="flex items-center space-x-3">
                    <div
                      className="relative w-10 h-10 rounded-full overflow-hidden bg-primary-green text-white flex items-center justify-center"
