...
export default function DashboardPage() {
    ...
    return (<div className="p-8 bg-gray-50">
      {/* Welcome Section */}
      <div className="mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {stats.map((stat, index) => (<div key={index} className="bg-white p-6 rounded-lg shadow-sm">
            ...
            <div className="flex items-baseline">
              ...
              {stat.change && (<span className={`ml-2 text-sm text-${stat.color}-600`}>
                  {stat.change}%
                </span>)}
            </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <div className="space-y-4">
            {activeProjects.map((project, index) => (<div key={index} className="flex items-center space-x-3">
