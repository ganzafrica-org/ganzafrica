...
export default function OpportunitiesPage(): React.ReactElement {
    ...
    const fetchOpportunities = async () => {
      try {
        ...
        const filteredOpportunities = allOpportunities.filter((opp: any) => {
          ...
          const validStatus =
            opp.status &&
            (opp.status.toLowerCase() === "published" || opp.status.toLowerCase() === "closed");
  ...
  const filteredOpportunities = opportunities.filter((opportunity) => {
    // Filter by status
    const statusMatch =
      opportunity.status && opportunity.status.toLowerCase() === selectedStatus.toLowerCase();
    ...
    if (selectedType !== "all") {
      if (selectedType === "fellowship") {
        ...
        typeMatch =
          !!opportunity.type &&
          ["employment", "internship", "full-time", "part-time", "contract"].includes(
  ...
  const employmentOpportunities = filteredOpportunities.filter((opp) =>
    ["employment", "internship", "full-time", "part-time", "contract"].includes(
    ...
    <main className="min-h-screen bg-white font-rubik">
      ...
      <section className="relative w-full h-[400px] sm:h-[500px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center z-20">
          ...
          >
            <TranslatableText>Be part of a</TranslatableText>{" "}
            <span className=" font-normal">
              <TranslatableText>dynamic team</TranslatableText>
            </span>{" "}
            <TranslatableText>driving transformation</TranslatableText>
          </motion.h2>
        </div>
      </section>
              ...
              <div className="space-y-6">
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">
                    <TranslatableText>Filter by Status</TranslatableText>
                  </h4>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-gray-800 mb-3">
                    <TranslatableText>Filter by Type</TranslatableText>
                  </h4>
                  <div className="flex flex-col gap-2">
            ...
            {loading ? (
              ...
              <div className="bg-white rounded-lg shadow-sm p-8 text-center border border-gray-200">
                <div className="text-gray-500 text-lg">
                  <TranslatableText>No current openings, please check back later</TranslatableText>
                </div>
                <p className="text-gray-400 mt-2">
                  <TranslatableText>
                    We also list opportunities on our social media platforms.
                  </TranslatableText>
                </p>
              </div>
            ) : (
                          ...
                          <div className="p-6">
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex items-center">
                                <div
                                  ...
                                  style={{
                                    backgroundColor: getOpportunityColor("fellowship") + "20",
                                    color: getOpportunityColor("fellowship"),
                                  }}
                                >
                            ...
                            <div className="mb-6">
                              ...
                              <ul className="text-sm text-gray-600 space-y-1 pl-5 list-disc">
                                {(
                                  opportunity.eligibility_criteria?.requirements
                                    ?.split("\n")
                                    .filter((req) => req.trim()) || [
                                ...
                                {(
                                  ...
                                  <li>
                                    <TranslatableText>And more...</TranslatableText>
                                  </li>
                                )}
                              </ul>
                            </div>
                ...
                {employmentOpportunities.length > 0 && (
                  <section id="employment" className="mb-16">
                    <div className="text-center mb-12">
                      <h2 className="text-3xl font-bold">
                        <span className="text-black">
                          <TranslatableText>Employment</TranslatableText>{" "}
                        </span>
                            ...
                            <div className="flex items-start justify-between mb-4">
                              <div className="flex items-center">
                                <div
                                  className="flex items-center justify-center w-12 h-12 rounded-full mr-4"
                                  style={{
                                    backgroundColor: getOpportunityColor(opportunity.type) + "20",
                                    color: getOpportunityColor(opportunity.type),
                                  }}
                                >
