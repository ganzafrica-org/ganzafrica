...
export const PersonIcon = ({className = "h-5 w-5 text-primary-green"}): JSX.Element => (
    ...
    >
        <path
            d="M30 15C34.1421 15 37.5 18.3579 37.5 22.5C37.5 26.6421 34.1421 30 30 30C25.8579 30 22.5 26.6421 22.5 22.5C22.5 18.3579 25.8579 15 30 15Z"/>
        <path d="M20 45C20 39.4772 24.4772 35 30 35C35.5228 35 40 39.4772 40 45"/>
        <path
            d="M43.5355 21.4645C45.4882 23.4171 46.6569 26.1435 46.6569 29C46.6569 31.8565 45.4882 34.5829 43.5355 36.5355M16.4645 36.5355C14.5118 34.5829 13.3431 31.8565 13.3431 29C13.3431 26.1435 14.5118 23.4171 16.4645 21.4645"/>
    </svg>
);
...
export const BikeIcon = ({className = "w-12 h-12", color = "white"}): JSX.Element => (
    ...
    >
        <path
            d="M4 4.5a.5.5 0 0 1 .5-.5H6a.5.5 0 0 1 0 1v.5h4.14l.386-1.158A.5.5 0 0 1 11 4h1a.5.5 0 0 1 0 1h-.64l-.311.935.807 1.29a3.5 3.5 0 1 1-.848.53l-.508-.812-2.076 3.322A.5.5 0 0 1 8 10.5H5.959a3.5 3.5 0 1 1-.5 0H4.5v.5h-2a.5.5 0 0 1 0-1h2v-.5H4.5a.5.5 0 0 1-.5-.5zM8.5 9a.5.5 0 0 1 .5.5v.5h1.05l-.212.636a.5.5 0 0 1-.171-.136l-.805-1.288a3.5 3.5 0 1 1 .779-.49l.226.361L10.413 8H9.5a.5.5 0 0 1-.5-.5V7h-1c-.003 0-.006 0-.007-.001A.498.498 0 0 1 8 7c0 .271.132.512.335.656.203.144.469.196.729.196h.341a3.5 3.5 0 0 1-.573-1H8.5zm2.5 3.5a.5.5 0 1 0-1 0 .5.5 0 0 0 1 0zm1.5-3a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5zm-7 1a2.5 2.5 0 1 0 0 5 2.5 2.5 0 0 0 0-5z"/>
    </svg>
);
...
export const TechnologyIcon = ({
    ...
    >
        ...
        >
            <path
                d="m5 16l5-3m4-2l5-3m-7-3v5m0 4v5M5 8l5 3m4 2l5 3m1.5-7v5.5m-7 6l5.5-3m-14.5 0l6 3m-7-5.5V9m1-2.5l6-3m9 3l-6-3"/>
