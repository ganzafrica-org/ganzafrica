...
export default function Footer({}: {}) {
  ...
  return (
    <footer className="bg-primary-green text-white py-1" id="footer-translate">
      <div
        className="pl-4 pr-3 sm:pl-6 sm:pr-4 md:pl-12 md:pr-8 lg:pl-16 lg:pr-10 xl:pl-[80px] xl:pr-[40px]"
        id="footer-translate-widget"
      >
        ...
        <div className="flex justify-between items-center mb-1 md:hidden">
          ...
          <div className="flex items-center justify-start space-x-1">
            ...
            <Link
              ...
              className="bg-white rounded-full p-1 hover:opacity-90 transition-opacity"
              onClick={() =>
                trackOutboundLink("https://linkedin.com/company/ganzafrica", "LinkedIn")
              }
            >
        ...
        <div className="hidden md:grid grid-cols-4 gap-1 items-center mb-1">
          ...
          <div className="flex items-center justify-start space-x-1">
            ...
            <Link
              ...
              onClick={() =>
                trackOutboundLink(
                  "https://www.linkedin.com/in/ganzafrica-foundation-87b998274/",
                  "LinkedIn",
                )
              }
            >
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-0 mb-1 md:space-x-4">
          {/* About GanzAfrica */}
          <div>
            <h3 className="font-semibold text-secondary-yellow mb-0.5 text-base">
              <TranslatableText>About GanzAfrica</TranslatableText>
            </h3>
          ...
          <div>
            <h3 className="font-semibold text-secondary-yellow mb-0.5 text-base">
              <TranslatableText>Our Approach</TranslatableText>
            </h3>
            <ul className="space-y-0">
              <li>
                <Link
                  href={`/our_approach/food_systems`}
                  className="hover:text-secondary-yellow transition-colors text-sm"
                >
