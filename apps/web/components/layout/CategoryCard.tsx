...
const CategoryCard = ({ 
  ...
  const colorClasses: Record<'primary-green' | 'yellow-400', string> = {
    ...
    'yellow-400': "bg-white border-l-12 border-yellow-400 relative after:content-[''] after:absolute after:left-0 after:top-4 after:h-[calc(100%-2rem)] after:w-3 after:bg-yellow-400"
  };
  ...
  return (
    <div className={cn(
      ...
      <div className="flex items-start">
        ...
        <div>
          <h3 className="text-xl font-bold mb-2 text-gray-900">{title}</h3> {/* Title color updated */}
