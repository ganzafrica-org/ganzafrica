                ...
                <nav className="container mx-auto px-4 py-6 flex flex-col space-y-4">
                    ...
                    <div className="flex flex-col">
                        ...
                        >
                            ...
                            <span className={`transform transition-transform ${activeDropdown === 'mobile-about' ? 'rotate-180' : ''}`}>▼</span>
                        </button>
                    ...
                    <div className="flex flex-col">
                        ...
                        >
                            ...
                            <span className={`transform transition-transform ${activeDropdown === 'mobile-what-we-do' ? 'rotate-180' : ''}`}>▼</span>
                        </button>
                            ...
                            <div className="ml-4 mt-2 flex flex-col space-y-2">
                                {whatWeDoItems.map((item) => (
                                    <Link
                                        ...
                                        prefetch={true}
                                    >
                                        {dict?.what_we_do?.[item.title.toLowerCase().replace(/ /g, '_')] || item.title}
                                    </Link>
                                ))}
                            </div>
                        )}
                    ...
                    <div className="flex flex-col">
                        ...
                        >
                            ...
                            <span className={`transform transition-transform ${activeDropdown === 'mobile-programs' ? 'rotate-180' : ''}`}>▼</span>
                        </button>
                    ...
                    <div className="flex flex-col">
                        ...
                        >
                            News & Updates
                            <span className={`transform transition-transform ${activeDropdown === 'mobile-news' ? 'rotate-180' : ''}`}>▼</span>
                        </button>
                                        ...
                                        <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                                ...
                                                <NavigationMenuLink asChild>
                                                    ...
                                                    >
                                                        ...
                                                        <p className="text-sm leading-tight text-muted-foreground">
                                                            Dedicated to creating a sustainable future for Africa through
                                            ...
                                            {aboutItems.map((item) => (
                                                <ListItem
                                                    key={item.href}
                                                    href={`/${locale}${item.href}`}
                                                    title={dict?.about?.[item.title.toLowerCase().replace(/ /g, '_')] || item.title}
                                                >
                                                    {item.description}
                                                </ListItem>
                                            ))}
                                        ...
                                        <ul className="grid gap-3 p-4 md:w-[400px] lg:w-[500px] lg:grid-cols-[.75fr_1fr]">
                                            <li className="row-span-3">
                                                <NavigationMenuLink asChild>
                                                    ...
                                                    >
                                                        ...
                                                        <p className="text-sm leading-tight text-muted-foreground">
                                                            Explore our programs focused on sustainable development, climate resilience,
                                            ...
                                            {whatWeDoItems.map((item) => (
                                                <ListItem
                                                    key={item.href}
                                                    href={`/${locale}${item.href}`}
                                                    title={dict?.what_we_do?.[item.title.toLowerCase().replace(/ /g, '_')] || item.title}
                                                >
                                                    {item.description}
                                                </ListItem>
                                            ))}
