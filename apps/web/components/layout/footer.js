...
export default function Footer({ locale, dict, }) {
    return (<footer className="bg-primary-green text-white py-1">
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-between items-center mb-4">
          ...
          <div className="flex-shrink-0">
            <Link href={`/${locale}`} prefetch={true}>
              <Image src="/images/logo-2.png" alt="GanzAfrica" width={120} height={40} className="h-auto w-auto"/>
            </Link>
          </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-4">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href={`${process.env.LOGIN_URL}`} className="hover:text-secondary-yellow transition-colors text-sm">
                  Member Login
                </a>
              </li>
              <li>
