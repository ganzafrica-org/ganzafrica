    ...
    <section className="relative w-full h-[400px] sm:h-[500px] overflow-hidden">
      ...
      <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center z-20">
        <h1 className="text-white text-3xl sm:text-4xl md:text-5xl font-bold mb-2 leading-tight">
          Rooted in <span className="text-primary-orange">Excellence</span>,<br />
          <span className="text-primary-orange">Growing</span> with <span className="text-primary-orange">Agriculture</span>
        </h1>
