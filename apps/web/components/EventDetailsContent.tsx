...
const eventData = {
  "official-launch": {
    ...
    attendees: 150,
    description:
      "The launch of the GanzAfrica Alumni Network marked a significant milestone in our journey towards transforming African food systems. This momentous occasion brought together fellows, partners, and distinguished guests to celebrate the power of collaboration and shared vision.",
    highlights: [
    ...
    gallery: ["/images/launch event.jpg", "/images/Happy fellows.jpg", "/images/form.jpg"],
  ...
  "lead-intentionally": {
    ...
    attendees: 120,
    description:
      "An intensive workshop designed to empower alumni with leadership skills and strategies for creating meaningful impact in their respective fields. This virtual gathering brings together experienced leaders and change-makers.",
    highlights: [
    ...
    gallery: ["/images/Sustainable Agriculture Fellows(1).jpg"],
  ...
  "power-of-networks": {
    ...
    attendees: 85,
    description:
      "Explore the transformative power of professional networks and learn how to leverage connections for collective impact in African agriculture and food systems.",
    highlights: [
    ...
    gallery: ["/images/Sustainable Land Use Fellows.jpg"],
...
export default function EventDetailsContent(): JSX.Element {
        ...
        <div className="absolute inset-0 flex items-center">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
            <SafeLink
              ...
              className="inline-flex items-center text-white mb-6 hover:text-[#F8B712] transition-colors"
            >
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {event.speakers.map((speaker, index) => (
                  <div
                    key={index}
                    className="bg-white p-6 rounded-xl shadow-md border-2 border-[#045f3c]"
                  >
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                {event.outcomes.map((outcome, index) => (
                  <div
                    key={index}
                    className="flex items-center gap-4 p-4 bg-[#045f3c]/5 rounded-lg"
                  >
