  ...
  return (
    <>
      ...
      >
        ...
        our traffic. By clicking "Accept All Cookies", you consent to our use of cookies. You can
        manage your preferences or learn more about our cookie policy in our{" "}
  ...
  const handleScroll = () => {
    ...
    window.requestAnimationFrame(() => {
      try {
        ...
        const percent = Math.min(100, Math.max(0, (scrollY / maxScrollable) * 100));
