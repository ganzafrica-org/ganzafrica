...
export default function OurStoryContent({ dict, isFrench }) {
    ...
    return (<div className="min-h-screen bg-white">
            ...
            <section className="relative w-full h-[400px] sm:h-[500px] overflow-hidden">
                ...
                <div className="absolute inset-0 z-0">
                    <Image src="/images/SHIR5142-Enhanced-NR.jpg" alt="Agricultural fields" fill className="object-cover object-center" style={{ objectPosition: "center 30%" }} priority/>
                </div>
    ...
    <div className="h-full w-full md:order-1 relative">
        <div className="w-full h-full relative hidden md:block">
            <video ref={videoRef} className="w-full h-full object-cover rounded-sm" src="/videos/lysa.mp4" autoPlay muted loop playsInline/>
