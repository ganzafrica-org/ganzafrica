...
const fallbackTestimonials: Testimonial[] = [
  {
    ...
    description:
      "I have found immense value in my role as a Smart Water fellow at GanzAfrica... a pivotal aspect of my journey has been participating in the MINAGRI team where collaboration with fellows from diverse backgrounds was key. I am confident that the lessons learned at GanzAfrica will contribute significantly",
  ...
  },
  {
    ...
    description:
      "The GanzAfrica fellowship transformed my career in agricultural innovation. Working alongside experienced mentors and a community of passionate professionals gave me the skills and network to make a real difference in my community.",
    image: "/images/ganzafrica-fellows.jpg",
    company: "GA",
    occupation: "fellow",
    date: new Date().toISOString(),
  ...
  },
  {
    ...
    description:
      "Being part of the GanzAfrica fellowship opened doors to incredible opportunities in climate action. The hands-on experience and mentorship I received helped me develop innovative solutions for sustainable agriculture.",
    image: "/images/ganzafrica-fellows.jpg",
    company: "GA",
    occupation: "fellow",
    date: new Date().toISOString(),
  ...
  },
  {
    ...
    description:
      "The fellowship program at GanzAfrica equipped me with crucial skills in data analysis and evidence-based decision making. The collaborative environment and expert guidance helped me grow both professionally and personally.",
    image: "/images/ganzafrica-fellows.jpg",
    company: "GA",
    occupation: "fellow",
    date: new Date().toISOString(),
  ...
  },
  {
    ...
    description:
      "Through the GanzAfrica fellowship, I gained practical experience in sustainable resource management. The program's focus on real-world challenges and innovative solutions has been invaluable for my career development.",
    image: "/images/ganzafrica-fellows.jpg",
    company: "GA",
    occupation: "fellow",
    date: new Date().toISOString(),
  ...
  const benefits = [
    {
      ...
      description:
        "Join a like-minded cohort to address major land, agricultural, and environmental challenges in Africa, making a meaningful impact in your community.",
      image: "/images/SHIR5142-Enhanced-NR.jpg",
    },
    {
      title: "Gain Global Experience",
      description:
        "Work on transformative projects with world-class industry specialists, be mentored by experts, and participate in the co-creation of innovative solutions in our focus areas.",
      image: "/images/Mico(Trainer).jpeg",
    },
    {
      title: "Develop Your Skills",
      description:
        "Our fully funded program offers training, apprenticeships, and work experience to enhance your expertise and showcase your talent.",
      image: "/images/ganzafrica-fellows.jpg",
    },
  ];
      ...
      <section className="relative h-[400px] md:h-[500px]">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <TranslatableText>
                Join our transformative fellowship program designed to empower the next generation
                of African leaders in sustainable development.
              </TranslatableText>
            </motion.p>
            {/*<motion.div*/}
            {/*    initial={{ opacity: 0, y: 20 }}*/}
          ...
          <div className="relative flex flex-col md:block">
            ...
            >
              ...
              <p className="text-gray-600 text-sm sm:text-base mb-6 sm:mb-8">
                <TranslatableText>
                  Our fully-funded program provides training, mentorship, and hands-on work
                  experience in land governance, environmental management, agrifood systems, climate
                  finance and other disciplines across our focus sectors. With specialized mentors
                  guiding you, you'll gain professional development and collaborate with talented
                  professionals. Plus, you'll have the opportunity to work on impactful projects
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 text-sm md:text-base mb-6">
                <TranslatableText>
                  A one-year program for those in early to mid career with exceptional ability and
                  intellectual curiosity who aspire to become public leaders.
                </TranslatableText>
              </p>
              <p className="text-gray-600 text-sm md:text-base mb-8">
                <TranslatableText>
                  Through our full-time Fellowship, we find people working on plans to make the
                  world better in a big way. Then we help them become impactful leaders by
                  connecting them with the tools, resources, and communities they need to bring
                  their ideas to life.
                </TranslatableText>
              </p>
              {/*<motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="inline-block">*/}
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-16">
          ...
          >
            <h2 className="text-2xl md:text-3xl font-bold mb-3">
              ...
              <span className="text-[#045F3C]">
                <TranslatableText> Joining GanzAfrica</TranslatableText>
              </span>
            </h2>
            <p className="text-gray-600 text-base">
              <TranslatableText>
                Begin your journey of impact and growth with GanzAfrica. Discover the benefits of
                joining our program:
              </TranslatableText>
            </p>
          </motion.div>
                ...
                >
                  ...
                  <div className="p-6">
                    <h3 className="text-lg font-bold mb-2">
                      <TranslatableText>{benefit.title}</TranslatableText>
                    </h3>
                    <p className="text-gray-600 text-sm md:text-base leading-relaxed">
                      <TranslatableText>{benefit.description}</TranslatableText>
                    </p>
                  </div>
                </motion.div>
              ))}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-start">
            ...
            >
              ...
              <p className="text-white/90 text-lg">
                <TranslatableText>
                  We are committed to providing a transformative experience that equips you with the
                  skills, network, and opportunities to make a lasting impact in your field.
                </TranslatableText>
              </p>
            </motion.div>
            ...
            >
              ...
              {promises.map((promise, index) => (
                ...
                >
                  <div
                    className={`${promise.color} w-12 h-12 rounded-full flex items-center justify-center text-white font-bold text-lg flex-shrink-0`}
                  >
                    {promise.number}
                  </div>
                  <div>
                    <h3 className="text-xl font-semibold text-white mb-2">
                      <TranslatableText>{promise.title}</TranslatableText>
                    </h3>
                    <p className="text-white/80">
                      <TranslatableText>{promise.description}</TranslatableText>
                    </p>
                  </div>
                </motion.div>
              ))}
