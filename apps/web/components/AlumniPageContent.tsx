          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-0 items-center">
            ...
            <div className="mt-10 md:mt-5 lg:mt-0">
              ...
              <p className="text-base text-gray-700 mb-6">
                Welcome to the GanzAfrica Alumni Network, a platform dedicated to creating strong
                bonds among young African professionals. Our goal is to foster trust, collaboration,
                and a vibrant exchange of ideas to shape sustainable and transformative solutions
                for Africa.
              </p>
              <p className="italic text-lg text-black font-normal mb-6 border-l-4 border-[#045f3c] pl-4">
                To cultivate a vibrant alumni community that drives the transformation of African
                food systems through evidence-based insights, mentorship, and
                collaboration—empowering current fellows and fostering partnerships that create
                lasting opportunities for sustainable impact.
              </p>
              <div className="flex gap-8 flex-wrap">
                {["Knowledge Sharing", "Mentorship", "Collaboration and Networking"].map(
                  (principle, index) => (
                ...
                >
                  ...
                  <div className="p-5 bg-white">
                    ...
                    <p className="text-sm text-gray-600 mb-4 line-clamp-2">
                      Young professionals are at the forefront of accelerating CAADP
                      implementation...
                    </p>
                    <span
