...
export function WhyGanza() {
  ...
  return (
    <section className="relative overflow-hidden px-4 py-20 md:py-25 sm:px-6 lg:px-8 bg-primary-green">
      ...
      />
      <div
        className="pointer-events-none absolute -bottom-20 -left-20 h-72 w-72 rounded-full opacity-30 blur-3xl"
        style={{ backgroundColor: "#FCF5E5" }}
      />
      ...
      >
        ...
        <motion.div
          ...
          className="text-white mb-12 flex flex-col items-start justify-between gap-6 sm:flex-row sm:items-center"
        >
        ...
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5 lg:gap-12">
          ...
          <motion.article variants={itemVariants} className="lg:col-span-2 order-2">
            <div className="relative">
              ...
              >
                <h3 className="text-sm sm:text-base lg:text-xl font-bold text-gray-900 mb-2 transition-colors duration-300 leading-tight text-primary-orange">
