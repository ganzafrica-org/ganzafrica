...
const ColoredCheckCircle = ({ color, className }: { color: string, className?: string }) => {
    return (
        <div className={`relative ${className}`}>
            <div className={`absolute inset-0 rounded-full ${color}`} style={{ zIndex: 1 }}></div>
...
export default function WhyGanzAfricaSection({ locale, dict }: WhyGanzAfricaSectionProps) {
                ...
                <div className="relative flex flex-col lg:flex-row items-stretch gap-12">
                    ...
                    <div className="relative flex-1 w-full max-w-lg mx-auto lg:mx-0 lg:self-stretch flex">
                        <div className="relative rounded-2xl overflow-hidden shadow-xl w-full h-full flex-1">
                            <Image
                                ...
                                alt={dict.about?.fellows_photo_alt || "GanzAfrica fellows collaborating"}
                                fill
                                priority
                            ...
                            <div className="absolute top-10 left-10 w-32">
                                ...
                                <div className="relative bg-secondary-yellow p-4 rotate-[-2deg] shadow-md rounded-md">
                                    <p className="text-dark font-bold text-sm leading-tight" style={{ fontFamily: "'Covered By Your Grace', cursive" }}>
                                        {dict.home?.why_section?.sticky_note_line1 || "Agriculture"}<br />
                                        {dict.home?.why_section?.sticky_note_line2 || "Professional"}<br />
                    ...
                    <div className="flex-1 lg:pl-8 flex flex-col">
                        ...
                        <div className="space-y-6">
                            {/* Bullet Point 1 */}
                            <div
                                ref={(el) => { bulletPointsRef.current[0] = el; return undefined; }}
                                className="flex items-start gap-4"
                            >
                                <div className="mt-1">
                                    <ColoredCheckCircle color="bg-primary-green" className="h-6 w-6" />
                                </div>
                                <div>
                                    <h4 className="font-bold-paragraph text-dark mb-1">
                                        {dict.home?.why_section?.point1_title || "We train and inspire future leaders"}
                                    </h4>
                            ...
                            {/* Bullet Point 2 */}
                            <div
                                ref={(el) => { bulletPointsRef.current[1] = el; return undefined; }}
                                className="flex items-start gap-4"
                            >
                                <div className="mt-1">
                                    <ColoredCheckCircle color="bg-secondary-green" className="h-6 w-6" />
                                </div>
                                <div>
                                    <h4 className="font-bold-paragraph text-dark mb-1">
                                        {dict.home?.why_section?.point2_title || "We drive continental collaboration"}
                                    </h4>
                                    <p className="text-gray-600 font-regular-paragraph">
                            ...
                            {/* Bullet Point 3 */}
                            <div
                                ref={(el) => { bulletPointsRef.current[2] = el; return undefined; }}
                                className="flex items-start gap-4"
                            >
                                <div className="mt-1">
                                    <ColoredCheckCircle color="bg-lighter-green-100" className="h-6 w-6" />
                                </div>
                                <div>
                                    <h4 className="font-bold-paragraph text-dark mb-1">
                            ...
                            {/* Bullet Point 4 */}
                            <div
                                ref={(el) => { bulletPointsRef.current[3] = el; return undefined; }}
                                className="flex items-start gap-4"
                            >
                                <div className="mt-1">
                                    <ColoredCheckCircle color="bg-primary-orange" className="h-6 w-6" />
                                </div>
                                <div>
                                    <h4 className="font-bold-paragraph text-dark mb-1">
