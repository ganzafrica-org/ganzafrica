...
export default function FlagshipProgramsSection({ locale, dict, }) {
    // Define SVG icons for each program
    const FellowshipIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const AlumniIcon = () => (<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    const programs = [
        {
            ...
            description: dict?.programs?.fellowship?.description ||
        ...
        },
        {
            ...
            description: dict?.programs?.alumni?.description ||
    ...
    return (<section className="flagship-programs-section py-16 md:py-24 bg-white relative border-t border-b border-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <DecoratedHeading firstText={dict?.programs?.flagship_heading_first || "Our Flagship"} secondText={dict?.programs?.flagship_heading_second || "Programs"} className="mx-auto"/>
          </div>

          <div className="flex flex-wrap justify-center gap-8">
            {programs.map((program) => (<article key={program.id} style={{
                position: 'relative',
                width: '350px',
                height: '350px',
                borderRadius: '3px',
