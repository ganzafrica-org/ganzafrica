        ...
        if (response) {
          if (response.data.projects && response.data.projects.length > 0) {
            ...
            const formattedProjects = filteredProjects.map((project) => ({
              ...
              media: {
                items:
                  project.media?.items?.map((item, idx) => ({
      ...
      <section className="py-4 md:py-6 bg-neutral-100 relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 max-w-6xl relative z-10">
          <div className="text-center mb-8">
            <DecoratedHeading firstText="Featured" secondText="Properties" className="mx-auto" />
          </div>
          ...
          <div className="text-center py-8">
            ...
            <p className="text-gray-600 max-w-md mx-auto">
              We don't have any projects running at the moment. Please check back later for upcoming
              properties.
            </p>
          </div>
    ...
    <section className="py-4 md:py-6 bg-neutral-100 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 max-w-7xl relative z-10">
        <div className="text-center mb-16">
          <DecoratedHeading firstText="Featured" secondText="Projects" className="mx-auto" />
        </div>
          ...
          {currentProjects.map((project, index) => {
            ...
            return (
              ...
              >
                ...
                <div className="relative h-48 overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
                    <span className="text-white font-medium text-lg">
                      <TranslatableText>{project.name}</TranslatableText>
                    </span>
                  </div>
                </div>
                ...
                <div className="p-6 flex-grow flex flex-col">
                  ...
                  >
                    <span className="border-b border-transparent group-hover:border-current transition-all duration-300">
                      <TranslatableText>{`Learn more about ${project.name}`}</TranslatableText>
                    </span>
                    <svg
                ...
                {/* Accent border - always at bottom */}
                <div className="h-1 w-full mt-auto" style={{ backgroundColor: color }}></div>
              </motion.div>
            );
          })}
        </div>
            ...
            {Array.from({ length: totalPages }).map((_, i) => (
              <button
                ...
                className={cn(
                  ...
                  activePage === i ? "bg-primary-green shadow-lg" : "bg-primary-orange/40",
                )}
