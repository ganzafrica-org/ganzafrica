...
const ColoredCheckCircle = ({ color, className, }) => {
...
export default function WhyGanzAfricaSection({ locale, dict, }) {
    ...
    return (<section ref={sectionRef} className="py-16 md:py-24 bg-white relative overflow-hidden">
        ...
        <div className="relative flex flex-col lg:flex-row items-stretch gap-12">
          ...
          <div className="relative flex-1 w-full max-w-lg mx-auto lg:mx-0 lg:self-stretch flex">
            <div className="relative rounded-2xl overflow-hidden shadow-xl w-full h-full flex-1">
              <Image src="/images/2-fellows.jpg" alt={dict.about?.fellows_photo_alt ||
            "GanzAfrica fellows collaborating"} fill priority className="object-cover"/>
            </div>
          </div>
          ...
          <div className="flex-1 lg:pl-8 flex flex-col">
            <div className="mb-8">
              <DecoratedHeading firstText={dict.home?.why_section?.heading_first || "Why"} secondText={dict.home?.why_section?.heading_second || "GanzAfrica?"} firstTextColor="text-primary-green" secondTextColor="text-primary-orange" borderColor="border-primary-green" cornerColor="bg-primary-orange"/>
            </div>
