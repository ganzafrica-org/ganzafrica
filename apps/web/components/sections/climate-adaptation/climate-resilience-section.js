    ...
    return (<section className="py-16 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-10 items-center">
          ...
          <motion.div className="md:col-span-5 relative mx-auto" variants={imageVariant} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }}>
            {/* Main image - circular */}
            <div className="rounded-full overflow-hidden w-[320px] h-[320px] relative">
              <Image src="/images/food-system-1.png" alt="Hands holding grains" fill className="object-cover"/>
            </div>
            ...
            <div className="absolute -bottom-5 -left-5 w-[120px] h-[120px] border-4 border-primary-green rounded-full overflow-hidden shadow-lg">
              <div className="w-full h-full bg-primary-green rounded-full flex items-center justify-center overflow-hidden">
                <Image src="/images/food-system.jpeg" alt="Young professional" fill className="object-cover"/>
              </div>
            </div>
          </motion.div>

          {/* Right Column - Text Content */}
          <motion.div variants={fadeIn} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-100px" }} className="md:col-span-7 space-y-6">
