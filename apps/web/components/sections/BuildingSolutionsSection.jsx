...
const BuildingSolutionsSection = ({ dict, categories, tags }) => {
  ...
  useEffect(() => {
    // Only run once the component is mounted and Matter.js is available
    if (!sceneRef.current || !window.Matter) return;
  ...
  return (
    <>
      {/* Load Matter.js from CDN before component renders */}
      <Script 
