    ...
    return (<section className="py-16 bg-white">
      <Container>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
          <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true, margin: "-100px" }} transition={{ duration: 0.7 }} className="relative h-full rounded-[20px] overflow-hidden">
            <Image src="/images/Fellows7.jpg" alt="Hands holding wheat grains" fill sizes="(max-width: 768px) 100vw, 50vw" className="object-cover"/>
          </motion.div>
