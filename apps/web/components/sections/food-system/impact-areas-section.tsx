...
const ImpactCard = ({ title, description, image }: { title: string; description: string; image: string }) => {
    return (
        <motion.div
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="ml-4">
                        <motion.div
                            ...
                            whileHover={{ scale: 1.1, backgroundColor: "rgba(5, 150, 105, 0.8)" }}
                            whileTap={{ scale: 0.95 }}
                        >
            ...
            <Container>
                ...
                >
                    ...
                    <p className="text-gray-600 max-w-3xl mx-auto">
                        ...
                        engagement to build future leaders who can drive meaningful change in
