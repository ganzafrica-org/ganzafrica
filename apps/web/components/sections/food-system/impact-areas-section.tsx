...
const DATA_POINTS = [
    {
        id: "proj-1", lat: -1.9441, lng: 30.0619, country: "Rwanda", city: "Kigali", short: "rw", percentage: 70,
        name: "Kigali Urban Farming Initiative", community: "Nyarugenge", contactPerson: "Jean Bosco",
        description: "Empowering youth through vertical farming and hydroponics in the heart of Kigali.",
        current: { value: "1,240", percent: "18.4", isGrown: true }, previous: { value: "320", percent: "12.1", isGrown: true },
    },
    {
        id: "proj-4", lat: -1.4994, lng: 29.634, country: "Rwanda", city: "Musanze", short: "rw", percentage: 55,
        name: "Musanze Potato Cooperative", community: "Musanze District", contactPerson: "Pierre Nkurunziza",
        description: "Supporting local farmers in sustainable potato cultivation and market access in Northern Rwanda.",
        current: { value: "890", percent: "14.2", isGrown: true }, previous: { value: "210", percent: "9.8", isGrown: true },
    },
    {
        id: "proj-5", lat: -1.8933, lng: 30.1065, country: "Rwanda", city: "Gasabo", short: "rw", percentage: 60,
        name: "Gasabo Youth Agricultural Hub", community: "Gasabo District", contactPerson: "Marie Claire Mukamana",
        description: "Training center for young agripreneurs in modern farming techniques and business skills.",
        current: { value: "740", percent: "22.0", isGrown: true }, previous: { value: "185", percent: "15.3", isGrown: true },
    },
    {
        id: "proj-10", lat: -1.2975, lng: 30.3259, country: "Rwanda", city: "Nyagatare", short: "rw", percentage: 50,
        name: "Nyagatare Livestock Development", community: "Nyagatare District", contactPerson: "Jean Baptiste Nsengiyumva",
        description: "Improving cattle rearing practices and veterinary services for pastoral communities.",
        current: { value: "620", percent: "10.5", isGrown: false }, previous: { value: "280", percent: "11.2", isGrown: false },
    },
    {
        id: "proj-17", lat: -2.0833, lng: 29.75, country: "Rwanda", city: "Muhanga", short: "rw", percentage: 45,
        name: "Muhanga Honey Production", community: "Muhanga District", contactPerson: "Fabrice Nsengimana",
        description: "Training beekeepers and establishing honey collection centers for improved income generation.",
        current: { value: "480", percent: "16.7", isGrown: true }, previous: { value: "140", percent: "11.4", isGrown: true },
    },
    {
        id: "proj-18", lat: -2.4699, lng: 29.4801, country: "Rwanda", city: "Nyamagabe", short: "rw", percentage: 40,
        name: "Nyamagabe Forest Conservation", community: "Nyamagabe District", contactPerson: "Eugene Nzabonimana",
        description: "Community-based forest conservation and agroforestry program in Southern Rwanda.",
        current: { value: "390", percent: "8.9", isGrown: true }, previous: { value: "95", percent: "7.2", isGrown: false },
    },
    {
        id: "proj-11", lat: 11.1771, lng: -4.2979, country: "Burkina Faso", city: "Bobo-Dioulasso", short: "bf", percentage: 55,
        name: "Bobo-Dioulasso Cotton Initiative", community: "Hauts-Bassins Region", contactPerson: "Amadou Traoré",
        description: "Supporting cotton farmers with improved seeds and access to international markets.",
        current: { value: "1,050", percent: "13.6", isGrown: true }, previous: { value: "270", percent: "10.1", isGrown: true },
    },
    {
...
export default function ImpactAreaSection() {
    ...
    const topCities = [...DATA_POINTS]
        .sort((a, b) => parseInt(b.current.value.replace(/,/g, "")) - parseInt(a.current.value.replace(/,/g, "")));
            ...
            <Container>
                ...
                >
                    ...
                    <p className="text-gray-700 max-w-3xl mx-auto mb-10 leading-relaxed">
                        <TranslatableText>
                            GanzAfrica operates across Africa, equipping young professionals with the skills and opportunities to
                            drive meaningful change in Africa's agri-food systems. We currently have projects in 2 countries.
                        </TranslatableText>
                    </p>
                    <div className="flex justify-center gap-12 sm:gap-20 mb-4">
                        <div className="flex flex-col items-center">
                            <p className="text-3xl font-bold text-green-700">8</p>
                            <p className="text-sm text-gray-600"><TranslatableText>Projects</TranslatableText></p>
                        </div>
                        <div className="flex flex-col items-center">
                            <p className="text-3xl font-bold text-green-700">2</p>
                            <p className="text-sm text-gray-600"><TranslatableText>Countries</TranslatableText></p>
                        </div>
                    </div>
                </motion.div>
                <div style={{
          ...
          `}</style>
                    ...
                    <div style={{
                        ...
                        <div style={{ position: "relative" }} onClick={e => e.stopPropagation()}>
                            ...
                            >
                <span style={{ fontSize: 14, fontWeight: 500, color: isDark ? "#e2e8f0" : "#111827" }}>
                  {selectedCountry}
                </span>
                                <svg
                                    width="14" height="14" viewBox="0 0 24 24" fill="none"
                                    stroke={isDark ? "#94a3b8" : "#6b7280"} strokeWidth="2.5"
                    ...
                    <div style={{
                        ...
                        {!leafletLoaded && (
                            <div style={{
                                ...
                                fontSize: 12, color: isDark ? "#38bdf8" : "#166534", letterSpacing: "0.15em",
                            }}>
                                LOADING MAP...
                            </div>
                        )}
                        ...
                        {selectedPoint && (
                            <div style={{
                                ...
                                borderRadius: 5, padding: "14px 16px", minWidth: 220, maxWidth: 280,
                                boxShadow: "0 8px 24px rgba(0,0,0,0.12)",
                            }}>
                                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                                    <div style={{ flex: 1, paddingRight: 8 }}>
                                        <div style={{ fontFamily: "'Syne', sans-serif", fontWeight: 700, fontSize: 12, lineHeight: 1.3 }}>
                                            {selectedPoint.name}
                                        </div>
                                        <div style={{ fontSize: 9, color: isDark ? "#64748b" : "#94a3b8", letterSpacing: "0.1em", marginTop: 3 }}>
                                            {selectedPoint.community} · {selectedPoint.country}
                                        </div>
                                    </div>
                                    <button onClick={() => setSelectedPoint(null)} style={{
                                        background: "none", border: "none", cursor: "pointer",
                                        color: isDark ? "#475569" : "#94a3b8", fontSize: 14, padding: 0, flexShrink: 0,
                                    }}>✕</button>
                                </div>
                                <div style={{ fontSize: 10, color: isDark ? "#64748b" : "#64748b", lineHeight: 1.5, marginBottom: 10 }}>
                                    {selectedPoint.description}
                                </div>
                                <div style={{ fontSize: 9, color: "#166534", letterSpacing: "0.08em", marginBottom: 8 }}>
                                ...
                                <div style={{ display: "flex", gap: 10 }}>
                                    {[
                                        ...
                                        <div key={label} style={{
                                            ...
                                            <div style={{ fontSize: 9, color: isDark ? "#475569" : "#94a3b8", letterSpacing: "0.08em", marginBottom: 4 }}>{label}</div>
                                            <div style={{ fontSize: 14, fontWeight: 500, color: isGrown ? "#16a34a" : "#ef4444" }}>{value}</div>
                                            <div style={{ display: "flex", alignItems: "center", gap: 3, marginTop: 3 }}>
                                                {isGrown ? <TrendUp /> : <TrendDown />}
                                                <span style={{ fontSize: 10, color: isGrown ? "#16a34a" : "#ef4444" }}>{percent}%</span>
                                            </div>
                                        </div>
                                    ))}
                                </div>
