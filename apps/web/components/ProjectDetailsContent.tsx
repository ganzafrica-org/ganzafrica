...
const ProjectDetailsPage = ({id}: ProjectDetailsContentProps): JSX.Element => {
            ...
            try {
                ...
                try {
                    ...
                    if (usersResponse.data && Array.isArray(usersResponse.data)) {
                        const usersData: User[] = usersResponse.data.map((user: {
                            id: number;
                            first_name: string;
                            last_name: string
                        }) => ({
                        ...
                        const usersData: User[] = usersResponse.data.users.map((user: {
                            id: number;
                            name?: string;
                            first_name?: string;
                            last_name?: string
    ...
    const getStatusBadge = (status: string | undefined) => {
        ...
        switch (status.toLowerCase()) {
            ...
            case 'planned':
                return (
                    <span
                        className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-yellow-100 text-yellow-800 whitespace-nowrap">
            ...
            default:
                return <span
                    className="px-2 py-1 text-xs font-medium rounded-full bg-gray-100 text-gray-800 truncate max-w-[100px]">• {status}</span>;
        }
    };
        ...
        return (
            <div className="p-6 max-w-full flex items-center justify-center min-h-[80vh]">
                <div className="text-center">
                    <div
                        className="animate-spin rounded-full h-12 w-12 border-t-2 border-b-2 border-green-700 mx-auto"></div>
        ...
        return (
            <div className="p-6 max-w-full">
                <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded relative" role="alert">
                    ...
                    <div className="mt-4">
                        <SafeLink href="/projects" aria-label="Move back to all projects"
                ...
                {featuredMedia ? (
                    ...
                    <div
                        ...
                        <div className="text-center">
                            ...
                            <p className="text-gray-400 text-lg"><TranslatableText>No featured image
                                available</TranslatableText></p>
                        </div>
                    </div>
                )}
                ...
                <div className="absolute inset-0 flex items-end">
                    <div className="container mx-auto px-4 pb-20">
                        <div className="max-w-4xl">
                            <SafeLink
                                href="/projects"
                                aria-label="Move back to all projects"
                                className="inline-flex items-center text-white/80 hover:text-white transition-all duration-300 mb-12 group"
                            >
                                <ArrowLeftIcon
                                    className="w-5 h-5 mr-2 group-hover:-translate-x-1 transition-transform"/>
                                <span
                                    className="relative after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-white after:transition-all after:duration-300 group-hover:after:w-full">
                  Back to Projects
                </span>
                            </SafeLink>
                  ...
                  <span
                      className="flex items-center bg-white/10 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full border border-white/10 hover:bg-white/20 transition-all duration-300 whitespace-nowrap">
                  ...
                  <span
                    ...
                    <span
                      ...
                      <span className="truncate">{getCategoryName(project.category_id)}</span>
                                ...
                                <div className="overflow-x-auto">
                                    <div
                                        className="bg-white/10 backdrop-blur-sm px-4 sm:px-6 py-2 sm:py-3 rounded-full border border-white/10 hover:bg-white/20 transition-all duration-300">
                    ...
                    <div className="lg:col-span-2 space-y-16 w-full overflow-hidden">
                        ...
                        <div className="space-y-8">
                            <div className="flex items-center gap-4 flex-wrap">
                                ...
                                <h2 className="text-2xl font-bold text-gray-900 dark:text-white break-words">About the
                                    Project</h2>
                            </div>
                        ...
                        {project.goals && project.goals.items && project.goals.items.length > 0 && (
                            <div className="space-y-8">
                                <div className="flex items-center gap-4 flex-wrap">
                                    <div className="h-0.5 w-12 bg-primary-green flex-shrink-0"></div>
                                    <h2 className="text-2xl font-bold text-gray-900 dark:text-white break-words">Project
                                        Goals</h2>
                                </div>
                                    ...
                                    {project.goals.items.map((goal) => (
                                        ...
                                        >
                                            <div className="flex items-center gap-4 mb-4">
                                                {goal.completed ? (
                                                    <div
                                                        className="w-12 h-12 rounded-full bg-green-100 dark:bg-green-900/50 flex items-center justify-center">
                                                        <CheckCircleIcon
                                                        ...
                                                        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-3">
                                                            {outcome.metrics.map((metric, index) => (
                                                                <div key={index} className="flex items-start gap-2">
                                                                    <span
                                                                        className="w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center mt-0.5 text-gray-600 dark:text-gray-300">•</span>
                                                                    <span
                                                                        className="text-gray-600 dark:text-gray-300">{metric}</span>
                                                                </div>
                                                            ))}
                                                        </div>
                                                    )}
                            ...
                            <div className="space-y-6">
                                <div className="flex justify-between flex-wrap gap-4">
                                    ...
                                    <p className="text-gray-600 dark:text-gray-400 text-sm max-w-md">
                                        Browse through this curated collection of images and videos that showcase key
                                        milestones.
                                    </p>
                                </div>
                                ...
                                <div className="relative group">
                                    {/* Featured Media */}
                                    <div
                                        className="relative aspect-[16/9] rounded-2xl overflow-hidden bg-gray-100 dark:bg-gray-800 group">
                              ...
                              `;
                                        ...
                                        {galleryMedia.length > 0 && activeImageIndex >= 0 && activeImageIndex < galleryMedia.length && galleryMedia[activeImageIndex] && galleryMedia[activeImageIndex]!.type === 'video' && (
                                            <div
                                                ...
                                                >
                                                    <div
                                                        className="w-0 h-0 border-t-[15px] border-t-transparent border-l-[25px] border-l-white border-b-[15px] border-b-transparent ml-2"></div>
                                                </button>
                                            </div>
                                        )}
                                        {galleryMedia.length > 0 && activeImageIndex >= 0 && activeImageIndex < galleryMedia.length && galleryMedia[activeImageIndex] && galleryMedia[activeImageIndex]!.caption && (
                                            <div
                                                className="absolute bottom-0 left-0 right-0 p-6 bg-gradient-to-t from-black/90 via-black/50 to-transparent translate-y-4 transition-transform duration-300 group-hover:translate-y-0">
                                    ...
                                    <div className="grid grid-cols-3 sm:grid-cols-4 md:grid-cols-6 gap-2 sm:gap-4 mt-4">
                                        {galleryMedia.map((item, index) => (
                                            ...
                                            >
                                                ...
                                                <div
                                                    className="absolute inset-0 bg-black/0 group-hover:bg-black/20 transition-colors duration-300"></div>
                                                {item.type === 'video' && (
                                                    <div className="absolute inset-0 flex items-center justify-center">
                                                        <div
                                                            className="w-8 h-8 text-primary-orange rounded-full flex items-center justify-center transform group-hover:scale-110 transition-transform duration-300">
                                                            <div
                                                                className="w-0 h-0 border-t-[6px] border-t-transparent border-l-[10px] border-l-white border-b-[6px] border-b-transparent ml-1"></div>
                                                        </div>
                                                    </div>
                                                )}
                                                {item.caption && (
                                                    <div
                                                        className="absolute inset-x-0 bottom-0 bg-gradient-to-t from-black/80 to-transparent p-2 translate-y-full group-hover:translate-y-0 transition-transform duration-300">
                            ...
                            {project.members && Array.isArray(project.members) && project.members.length > 0 ? (
                                <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6">
                                    ...
                                    `;
                                                        ...
                                                        <div
                                                            className="w-12 h-12 flex items-center justify-center bg-gray-200 rounded-full dark:bg-gray-700 flex-shrink-0">
                              <span className="text-lg font-bold text-gray-700 dark:text-gray-300">
                                ...
                                <div className="p-6 bg-gray-50 dark:bg-gray-800 rounded-2xl text-center">
                                    <p className="text-gray-600 dark:text-gray-400">No team members assigned to this
                                        project</p>
                                </div>
                            )}
                        </div>
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        {project.partners.map((partner, index) => {
                                            ...
                                            return (
                                                ...
                                                >
                                                    <div
                                                        className="w-20 h-20 bg-white dark:bg-gray-700 rounded-lg flex items-center justify-center overflow-hidden">
                                                        {partnerLogo ? (
                                                            <img
                                                                src={partnerLogo}
                                                                alt={partnerName}
