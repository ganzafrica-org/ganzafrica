...
const ProjectDetailsPage = ({ id }: ProjectDetailsContentProps): JSX.Element => {
      ...
      try {
        ...
        try {
          ...
          if (usersResponse.data && Array.isArray(usersResponse.data)) {
            const usersData: User[] = usersResponse.data.map(
            ...
            const usersData: User[] = usersResponse.data.users.map(
  ...
  // Find featured media
  const featuredMedia =
    project.media && project.media.items
          ...
          <div className="w-full h-full bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 flex items-center justify-center">
            <div className="text-center">
              ...
              <p className="text-gray-400 text-lg">
                <TranslatableText>No featured image available</TranslatableText>
              </p>
            </div>
          </div>
        )}
                    ...
                    >
                      <div className="flex items-start gap-6">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-lg text-gray-600 dark:text-gray-400 leading-relaxed break-words">
                            {outcome.description}
                          </p>
                            ...
                            <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-3">
                              {outcome.metrics.map((metric, index) => (
                                <div key={index} className="flex items-start gap-2">
                                  <span className="w-6 h-6 rounded-full bg-gray-100 dark:bg-gray-700 flex items-center justify-center mt-0.5 text-gray-600 dark:text-gray-300">
                                    •
                                  </span>
