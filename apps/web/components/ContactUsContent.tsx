        ...
        >
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <motion.div
              ...
              animate="visible"
            >
              <motion.h2 className="text-2xl font-bold text-[#005c3d] " variants={itemFadeIn}>
              ...
              {formError && (
                <div className="bg-red-50 border border-red-200 text-red-700 px-4 py-3 rounded-lg flex items-start">
                  ...
                  <div>
                    ...
                    <p className="text-sm">
                      <TranslatableText>{formError}</TranslatableText>
                    </p>
                  </div>
                </div>
              )}
            ...
            >
              <motion.div className="bg-[#FFFDEB] rounded-lg p-8" variants={itemFadeIn}>
                ...
                <p className="text-gray-600 mb-6">
                  <TranslatableText>
                    Subscribe to our newsletter to receive updates about our programs, events, and
                    opportunities.
                  </TranslatableText>
                </p>
