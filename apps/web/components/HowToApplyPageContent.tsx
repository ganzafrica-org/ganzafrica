...
export default function HowToApplyPageContent() {
  ...
  const heroTitle = "Apply by completing our";
  const heroEmphasis = "online application";
  const heroSubtitle =
  ...
  const defaultSteps = [
    {
      ...
      description:
        "GanzAfrica Fellowship opportunities are announced through our online channels and partner networks across Africa.",
    ...
    },
    {
      ...
      description:
        "Submit your application through our online portal. Make sure to include all required documents and information.",
    ...
    },
    {
      ...
      description:
        "Our team carefully reviews each application, assessing qualifications, experience, and alignment with our mission.",
    ...
    },
    {
      ...
      description:
        "Selected candidates are invited to participate in oral and written interviews to further assess their suitability.",
    ...
    },
    {
      ...
      description:
        "Successful candidates are notified and begin their journey with GanzAfrica Fellowship Program.",
      image: "/images/fellows-notified.png",
    },
  ];

  const applicationSteps = defaultSteps;
  ...
  const defaultEligibility = [
    ...
    },
    {
      ...
      description:
        "Academic background in agriculture, environmental science, data science, or related fields",
    },
    {
  ...
  const eligibilityCriteria = defaultEligibility;
  ...
  const FloatingApplyButton = () => {
    ...
    useEffect(() => {
      const findFooterSection = () => {
        ...
        if (connectSection) {
          const parentSection = connectSection.closest(
            'section, footer, [class*="footer"], [class*="Footer"]',
          ) as HTMLElement;
        ...
        (entries) => {
          entries.forEach((entry) => {
            if (entry.isIntersecting) setIsVisible(false);
              ...
              entry.boundingClientRect.top + window.scrollY - 200
            )
              setIsVisible(true);
          });
        },
    ...
    return (
      <AnimatePresence>
        {isVisible && (
          ...
          >
            <Link
              href={`/programs/fellowship/apply`}
              aria-label="Know more on how to apply for fellowship program"
            >
              <Button
      ...
      <section className="relative h-[500px] bg-[url('/images/Welcoming.jpg')] bg-cover bg-center">
        ...
        <div className="relative z-10 h-full flex items-center justify-center">
          <div className="container mx-auto px-4 text-center">
            ...
            >
              <TranslatableText>{heroTitle}</TranslatableText>
              <br />
              <span className="text-primary-orange">
                <TranslatableText>{heroEmphasis}</TranslatableText>
              </span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0, y: 20 }}
        ...
        <Container className="relative">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-center mb-16">
              <TranslatableText>Application</TranslatableText>
              <TranslatableText>Process</TranslatableText>
              ...
              {applicationSteps.map((step: any, index: number) => (
                ...
                >
                  ...
                  <div className="flex-1 bg-white rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow duration-300">
                    <h3 className="text-2xl font-semibold text-[#045F3C] mb-3">
                      <TranslatableText>{step.title}</TranslatableText>
                    </h3>
                    <p className="text-gray-600 text-lg leading-relaxed">
                      <TranslatableText>{step.description}</TranslatableText>
                    </p>
                  </div>
                </motion.div>
              ))}
          ...
          >
            <div className="text-center mb-16">
              <h2 className="text-4xl font-bold mb-4">
                <TranslatableText>Eligibility</TranslatableText>
              </h2>
              <p className="text-gray-600 text-lg">
                <TranslatableText>
                  Requirements for the GanzAfrica Fellowship Program
                </TranslatableText>
              </p>
            </div>
              ...
              <div className="space-y-8">
                {eligibilityCriteria.map((criteria: any, index: number) => (
                  ...
                  >
                    ...
                    <div>
                      <h3 className="text-2xl font-semibold text-[#045F3C] mb-3">
                        <TranslatableText>{criteria.title}</TranslatableText>
                      </h3>
                      <p className="text-gray-600 text-lg leading-relaxed">
                        <TranslatableText>{criteria.description}</TranslatableText>
                      </p>
                    </div>
                  </motion.div>
                ))}
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-12">
            <h2 className="text-5xl font-bold text-[#045F3C] relative inline-block tracking-tight">
              <TranslatableText>FELLOWSHIP JOURNEY</TranslatableText>
          ...
          <div className="relative mt-24">
            <div className="max-w-7xl grid grid-cols-1 lg:grid-cols-4 gap-x-4 gap-y-16 relative">
              ...
              >
                <motion.p
                  className="text-[#045F3C] text-center mb-8 h-20 text-md max-w-[280px] font-medium"
                  initial={{ opacity: 0 }}
              ...
              >
                ...
                >
                  <TranslatableText>
                    GanzAfrica Academy provides capacity building on data-led approaches and
                    leadership
                  </TranslatableText>
                </motion.p>
                <motion.div
              ...
              >
                ...
                >
                  <TranslatableText>
                    Fellows are placed in public institutions and empowered to shape policy
                    approaches
                  </TranslatableText>
                </motion.p>
                <motion.div
              ...
              >
                ...
                >
                  <TranslatableText>
                    Fellows receive mentorship from experts, advancing their careers, leadership
                    skills, and providing ongoing support
                  </TranslatableText>
                </motion.p>
                <motion.div
