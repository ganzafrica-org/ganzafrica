...
export const metadata: Metadata = {
    ...
    description: "Read GanzAfrica's latest blog posts on sustainable agriculture, land management, food systems transformation, and youth empowerment across Africa.",
    keywords: [
        "GanzAfrica blog",
    ...
    openGraph: {
        title: "Blog | GanzAfrica - Agriculture & Sustainability Insights",
        description: "Read GanzAfrica's latest insights on sustainable agriculture, land management, and food systems transformation.",
        siteName: "GanzAfrica",
        type: "website",
        url: `${baseUrl}/blogs`,
        images: [{
