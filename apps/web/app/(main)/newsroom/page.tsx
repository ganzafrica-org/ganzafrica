...
export const metadata: Metadata = {
  ...
  description:
    "Stay updated with GanzAfrica's latest news: fellowship cohorts, agriculture training milestones, sustainable land management projects, and food systems transformation across Africa.",
  keywords: [
    "GanzAfrica news",
  ...
  openGraph: {
    title: "Newsroom | GanzAfrica - Latest News & Updates",
    description:
      "Stay updated on GanzAfrica's agriculture training programs, new fellowship cohorts, and sustainability initiatives.",
    siteName: "GanzAfrica",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Stay updated with GanzAfrica's latest news and updates on agriculture training and sustainability.",
    creator: "@GanzAfrica",
