...
export const metadata: Metadata = {
  ...
  description:
    "Join GanzAfrica's fellowship program: comprehensive agriculture training, mentorship, and work placements for African youth in sustainable land management and data-driven decision-making.",
  keywords: [
  ...
  openGraph: {
    title: "Fellowship Program | GanzAfrica - Agriculture Training Fellowship",
    description:
      "Join GanzAfrica's comprehensive fellowship program combining agriculture training, mentorship, and work placements for African youth.",
    siteName: "GanzAfrica",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Join GanzAfrica's agriculture fellowship program for comprehensive training and mentorship.",
    creator: "@GanzAfrica",
