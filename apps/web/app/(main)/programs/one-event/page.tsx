...
export const metadata: Metadata = {
  ...
  description:
    "Discover GanzAfrica's upcoming events, workshops, and training sessions on agriculture, sustainable land management, and food systems transformation across Africa.",
  keywords: [
    "GanzAfrica events",
  ...
  openGraph: {
    title: "Events | GanzAfrica - Agriculture Training Events & Workshops",
    description:
      "Join GanzAfrica's events and workshops on agriculture, sustainable land management, and food systems transformation.",
    siteName: "GanzAfrica",
    type: "website",
