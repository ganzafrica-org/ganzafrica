...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
    try {
        ...
        return {
            ...
            description: event.description?.substring(0, 160) || event.summary || "Join GanzAfrica's agriculture training event.",
            keywords: [
                "GanzAfrica events",
            ...
            openGraph: {
                ...
                description: event.description || event.summary || "Join GanzAfrica's agriculture training event.",
                siteName: "GanzAfrica",
                type: "website",
