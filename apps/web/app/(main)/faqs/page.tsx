        ...
        setFaqs([
          {
            ...
            answer:
              "Our fellowship program includes rigorous training in data analysis, systems thinking, and evidence-based decision making. Fellows gain practical experience through placement in partner public institutions while receiving mentorship and professional development opportunities.",
            is_active: true,
            view_count: 0,
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span className="text-primary-orange">
                <TranslatableText>Answers</TranslatableText>
              </span>{" "}
              <TranslatableText>to Help You</TranslatableText>
              <br />
          ...
          <div className="marquee-container overflow-hidden w-full max-w-2xl mx-auto">
            <div className="marquee-content flex whitespace-nowrap animate-marquee">
              <div className="flex space-x-8 px-4 mx-4">
                ...
                <span className="text-base font-medium">
                  • <TranslatableText>Data & Evidence</TranslatableText>
                </span>
                <span className="text-base font-medium">
                  • <TranslatableText>Co-creation</TranslatableText>
                </span>
                <span className="text-base font-medium">
                  • <TranslatableText>Data & Evidence</TranslatableText>
                </span>
            ...
            {loading ? (
              ...
              <>
                <h2 className="text-2xl font-bold text-emerald-600 mb-4">
                  <TranslatableText>General FAQs</TranslatableText>
                </h2>
