...
export const metadata: Metadata = {
  ...
  description:
    "Discover career opportunities, fellowships, and training programs in agriculture, sustainable land management, and data analytics for African youth at GanzAfrica.",
  keywords: [
  ...
  openGraph: {
    title: "Opportunities | GanzAfrica - Careers, Fellowships & Training Programs",
    description:
      "Explore career opportunities, fellowships, and training programs in agriculture and sustainability for African youth.",
    siteName: "GanzAfrica",
    type: "website",
