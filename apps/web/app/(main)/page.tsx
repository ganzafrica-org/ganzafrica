...
export async function generateMetadata(): Promise<Metadata> {
  return baseGenerateMetadata({
    ...
    description:
      "GanzAfrica offers innovative training, mentorship, and work placement programs preparing African youth for careers in agriculture, sustainable land management, and data-driven decision-making. Join us in transforming Africa's food systems.",
