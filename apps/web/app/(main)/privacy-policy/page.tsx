...
export const metadata: Metadata = {
  ...
  description:
    "Learn how GanzAfrica collects, uses, and protects your personal data. We are committed to transparency and safeguarding your privacy across our operations.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Our commitment to your privacy. Learn about how GanzAfrica handles your information with care and transparency.",
    siteName: "GanzAfrica",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "Your data privacy is our priority. Read GanzAfrica's privacy policy to understand how we protect your information.",
    creator: "@GanzAfrica",
