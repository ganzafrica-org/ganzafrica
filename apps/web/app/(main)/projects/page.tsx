...
export const metadata: Metadata = {
    ...
    description: "Explore GanzAfrica's impactful projects in agriculture, sustainable land management, food systems transformation, and environmental conservation across Africa.",
    keywords: [
        "GanzAfrica projects",
    ...
    openGraph: {
        title: "Projects | GanzAfrica - Agriculture & Sustainability Projects",
        description: "Discover GanzAfrica's impactful projects transforming agriculture and food systems across Africa.",
        siteName: "GanzAfrica",
        type: "website",
