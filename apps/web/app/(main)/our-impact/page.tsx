            ...
            <div className="flex flex-col gap-4">
                {stats.map((stat, index) => (
                    <div key={index}
                        ...
                        <div className="font-semibold text-gray-700 text-sm uppercase tracking-wider">{stat.label}</div>
                        {stat.description && (
...
export default function AfricaPage() {
    ...
    const currentData = (selectedCountry && selectedCountry in countryData)
        ...
        <main className="flex flex-col min-h-screen">
            <section className="relative w-full h-[400px] sm:h-[500px] overflow-hidden">
                <div className="absolute inset-0 z-0">
                    <Image src="/images/form.jpg" alt="Opportunities" fill className="object-cover" priority />
                </div>
