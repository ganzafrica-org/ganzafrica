...
export const metadata: Metadata = {
  ...
  description:
    "Learn GanzAfrica's origin story: empowering African youth through agriculture training, sustainable land management, and data literacy programs since our founding.",
  keywords: [
    "GanzAfrica story",
    "GanzAfrica origins",
    "GanzAfrica mission",
  ...
  openGraph: {
    ...
    description:
      "Discover how GanzAfrica began its mission to transform African agriculture through training, mentorship, and real-world placements for the next generation of leaders.",
    siteName: "GanzAfrica",
    type: "website",
  ...
  twitter: {
    ...
    description:
      "How GanzAfrica built a fellowship transforming African youth into agriculture and sustainability leaders through training and mentorship.",
    creator: "@GanzAfrica",
