...
import { ArrowLeft, Calendar, MapPin, Tag, Clock, GraduationCap, Globe, Briefcase, Code, ListChecks, AlertCircle, FileText, CheckCircle, Book, Users, Laptop, Award, Target } from 'lucide-react';
...
const OpportunityDetailsPage = () => {
    ...
    const getStatusBadge = (status) => {
        ...
        switch (status.toLowerCase()) {
            ...
            case 'draft':
                return (<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray-100 text-gray-800 whitespace-nowrap">
            <Clock className="w-3 h-3 mr-1 flex-shrink-0"/>
            <span className="truncate">Draft</span>
          </span>);
            case 'archived':
                return (<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-purple-100 text-purple-800 whitespace-nowrap">
            <Book className="w-3 h-3 mr-1 flex-shrink-0"/>
            <span className="truncate">Archived</span>
          </span>);
            case 'closed':
                return (<span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-orange-100 text-orange-800 whitespace-nowrap">
        ...
        <div className="absolute inset-0 flex items-end">
          <div className="container mx-auto px-4 pb-12">
            <div className="max-w-4xl">
              <Link href="/opportunities" className="inline-flex items-center text-white/80 hover:text-white transition-all duration-300 mb-6 group">
              ...
              <div className="flex flex-wrap gap-4 text-white/90 mb-8 overflow-hidden max-w-full">
                ...
                {opportunity.location && (<div className="overflow-x-auto">
                    <span className="flex items-center bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full border border-white/10 hover:bg-white/20 transition-all duration-300 whitespace-nowrap">
      ...
      <div className="container mx-auto px-4 md:px-8 lg:px-20 py-16">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-16 w-full overflow-hidden">
            ...
            {/* Eligibility */}
            {opportunity.eligibility_criteria && (<div className="space-y-8">
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="h-0.5 w-12 bg-green-700 flex-shrink-0"></div>
            ...
            {opportunity.type === 'fellowship' && opportunity.fellowship_details && (<div className="space-y-8">
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="h-0.5 w-12 bg-green-700 flex-shrink-0"></div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 space-y-8">
                  {/* Learning outcomes */}
                  {opportunity.fellowship_details.learning_outcomes && opportunity.fellowship_details.learning_outcomes.length > 0 && (<div>
                ...
                opportunity.fellowship_details.program_structure.phases.length > 0 && (<div>
            ...
            {/* Application Form */}
            {opportunity.custom_questions && opportunity.custom_questions.length > 0 && (<div className="space-y-8">
                <div className="flex items-center gap-4 flex-wrap">
                  <div className="h-0.5 w-12 bg-green-700 flex-shrink-0"></div>
          ...
          <div className="lg:col-span-1 space-y-8">
            ...
            <div className="sticky top-4">
              ...
              <Link href={`${opportunity.id}/apply`} className="w-full block text-center px-4 py-3 bg-green-700 rounded-lg text-sm font-medium text-white hover:bg-green-800 transition-colors">
  Apply to Opportunity
              ...
              {opportunity.type === 'fellowship' && opportunity.fellowship_details && (<div className="space-y-8">
                  ...
                  <div className="space-y-4 w-full overflow-hidden bg-white rounded-lg border border-gray-200 p-6">
                    ...
                    {opportunity.fellowship_details.duration && (<div className="p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center mb-2">
                          <Clock className="w-4 h-4 text-gray-500 mr-2"/>
                    ...
                    {opportunity.fellowship_details.start_date && (<div className="p-4 bg-gray-50 rounded-lg">
                        <div className="flex items-center mb-2">
                          <Calendar className="w-4 h-4 text-gray-500 mr-2"/>
