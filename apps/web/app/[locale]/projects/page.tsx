...
export async function generateMetadata({
    ...
    return baseGenerateMetadata({
        ...
        description: 'Explore our impact-focused projects in sustainable agriculture and climate change adaptation in Rwanda.',
            ...
            <div className="bg-muted py-16">
                <div className="container mx-auto px-4">
                    ...
                    <p className="text-lg text-muted-foreground max-w-2xl">
                        Explore our impact-focused projects in sustainable agriculture and climate change adaptation.
                    </p>
                </div>
            </div>
