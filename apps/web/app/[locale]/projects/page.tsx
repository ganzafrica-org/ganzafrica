...
import { ArrowRight, Play, Volume2, Maximize, Search, Filter, MapPin, X, ChevronRight, ExternalLink, Info } from 'lucide-react';
...
const ProjectsPage = (): JSX.Element => {
  ...
  const projectLocations = [
    ...
    },
    {
      ...
      description: 'Developing urban agricultural technologies and training young entrepreneurs in modern farming techniques.',
      image: '/images/maize.avif',
      country: 'rwanda',
      location: 'Kigali',
