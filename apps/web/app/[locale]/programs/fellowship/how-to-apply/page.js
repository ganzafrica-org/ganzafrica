          ...
          <Container className="relative">
            <div className="max-w-4xl mx-auto">
              ...
              <div className="relative">
                ...
                {/* Timeline Items */}
                {applicationSteps.map((step, index) => (<motion.div key={step.id} initial={{ opacity: 0, x: -50 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.2 }} className="flex gap-8 mb-16 relative">
            ...
            <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} className="max-w-4xl mx-auto">
              ...
              <div className="bg-white rounded-2xl p-10 shadow-xl border border-gray-100 hover:shadow-2xl transition-shadow duration-300">
                <div className="space-y-8">
                  {eligibilityCriteria.map((criteria, index) => (<motion.div key={index} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: index * 0.2 }} className="flex items-start gap-6 relative">
            ...
            <div className="relative mt-24">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-4 gap-x-4 gap-y-16 relative">
                ...
                <motion.div className="flex flex-col items-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0 }}>
                  <motion.p className="text-[#045F3C] text-center mb-8 h-20 text-lg max-w-[280px] font-medium" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.2 }}>
                    High-achieving young professionals are recruited as GanzAfrica fellows
                  </motion.p>
                  <motion.div className="w-28 h-28 rounded-full bg-[#FDB022] flex items-center justify-center relative z-10 shadow-lg" initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ type: "spring", stiffness: 200, damping: 20, delay: 0.4 }}>
                ...
                <motion.div className="flex flex-col items-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.3 }}>
                  <motion.p className="text-[#045F3C] text-center mb-8 h-20 text-lg max-w-[280px] font-medium" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.5 }}>
                    GanzAfrica Academy provides capacity building on data-led approaches and leadership
                  </motion.p>
                  <motion.div className="w-28 h-28 rounded-full bg-[#0000CC] flex items-center justify-center relative z-10 shadow-lg" initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ type: "spring", stiffness: 200, damping: 20, delay: 0.7 }}>
                ...
                <motion.div className="flex flex-col items-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.6 }}>
                  <motion.p className="text-[#045F3C] text-center mb-8 h-20 text-lg max-w-[280px] font-medium" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 0.8 }}>
                    Fellows are placed in public institutions and empowered to shape policy approaches
                  </motion.p>
                  <motion.div className="w-28 h-28 rounded-full bg-[#00A15D] flex items-center justify-center relative z-10 shadow-lg" initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ type: "spring", stiffness: 200, damping: 20, delay: 1 }}>
                ...
                <motion.div className="flex flex-col items-center" initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.9 }}>
                  <motion.p className="text-[#045F3C] text-center mb-8 h-20 text-lg max-w-[280px] font-medium" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} transition={{ duration: 0.5, delay: 1.1 }}>
                    Fellows receive mentorship from experts, advancing their careers, leadership skills, and providing ongoing support
                  </motion.p>
                  <motion.div className="w-28 h-28 rounded-full bg-[#045F3C] flex items-center justify-center relative z-10 shadow-lg" initial={{ scale: 0 }} whileInView={{ scale: 1 }} transition={{ type: "spring", stiffness: 200, damping: 20, delay: 1.3 }}>
