...
const journeySteps: JourneyStep[] = [
  {
    ...
    duration: "2 MONTHS",
    description:
      "Workshops and skills development modules that establish a strong foundation of knowledge and practical capabilities.",
  },
  {
    id: "02",
    title: "Placement",
    duration: "2 MONTHS",
    description:
      "Fellows are deployed to partner organizations—including government agencies, NGOs, and private sector firms—where they contribute to meaningful projects while gaining professional experience.",
  },
];
      ...
      <section className="relative w-full h-[400px] sm:h-[500px] overflow-hidden">
        ...
        <div className="relative container mx-auto px-4 h-full flex flex-col justify-center items-center text-center z-20">
          <h1 className="text-white text-2xl sm:text-3xl md:text-4xl font-bold mb-2 leading-tight">
            ...
            <span className=" font-bold text-yellow-400">Tomorrow's </span>
            <br />
            ...
            <div ref={contentRef} className="lg:w-[58%]">
              ...
              <div className="space-y-4">
                <p className="text-gray-800 text-base leading-relaxed">
                  The GanzAfrica Fellowship Program is a transformative
                  initiative that empowers emerging leaders in Africa's land,
                  agriculture, and environmental sectors. Through intensive
                  training and hands-on experience, fellows develop the skills
                  and networks needed to drive sustainable change in their
                  communities.
                </p>
                <p className="text-gray-800 text-base leading-relaxed">
                  Our program combines theoretical learning with practical
                  application, preparing fellows to tackle real-world challenges
                  in agricultural innovation, land governance, and environmental
                  sustainability.
                </p>
              </div>
        ...
        <div className="flex justify-center mb-8 sm:mb-12 md:mb-16">
          <div className="relative inline-block">
            <div className="flex justify-center mb-6 sm:mb-10">
              <DecoratedHeading firstText="Fellow" secondText="Activities" />
            </div>
          </div>
        </div>
              ...
              <div className="overflow-hidden">
                ...
                >
                        ...
                        <div className="relative w-full overflow-hidden">
                          ...
                          <div className="relative">
                            ...
                            <div className="card-image relative aspect-[16/9] w-full overflow-hidden">
                              <Image
                                src={
                                  project.image || "/images/default-image.jpg"
                                }
                                alt={project.title}
                                fill
                  ...
                  <div
                    ...
                    className="flex gap-8 min-w-full flex-shrink-0"
                  >
                    {[...projects.slice(1, 3), { ...projects[0], id: 4 }].map(
                      (project) => (
                        <div
                          key={`project-${project.id}`}
                          className="project-card flex-1 group relative bg-white shadow-lg hover:shadow-xl transition-all duration-300 rounded-2xl overflow-hidden cursor-pointer"
