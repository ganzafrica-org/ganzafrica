...
import { Calendar, Clock, MapPin, Users, Camera, Share2, Download, ChevronLeft, MessageCircle, Heart, } from "lucide-react";
    ...
    return (<main className="min-h-screen bg-white font-rubik">
      ...
      <div className="relative h-[400px]">
        <div className="absolute inset-0">
          <img src="/images/launch event.jpg" alt="Event Cover" className="w-full h-full object-cover"/>
          ...
          <div className="lg:col-span-2">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {event.highlights.map((highlight, index) => (<div key={index} className="flex items-start gap-3 bg-gray-50 p-4 rounded-lg">
            ...
            <section className="mb-12">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {event.speakers.map((speaker, index) => (<div key={index} className="bg-white p-6 rounded-xl shadow-md border-2 border-[#045f3c]">
            ...
            <section className="mb-12">
              ...
              <div className="space-y-4">
                {event.outcomes.map((outcome, index) => (<div key={index} className="flex items-center gap-4 p-4 bg-[#045f3c]/5 rounded-lg">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                {event.gallery.map((image, index) => (<div key={index} className="relative group">
                    <img src={image} alt={`Event photo ${index + 1}`} className="w-full h-64 object-cover rounded-lg"/>
