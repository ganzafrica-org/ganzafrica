...
import { ArrowRight, CheckCircle2, Users, Briefcase, Calendar, Sprout, TreePine, Cloud, } from "lucide-react";
...
export default function Home() {
    ...
    return (<main className="min-h-screen bg-white font-rubik">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        <img src="/images/leaf.jpg" alt="Background Pattern" className="w-full h-full object-cover opacity-[0.08]"/>
      </div>

      {/* Hero Section - Full width */}
      <section className="relative w-full h-[400px] sm:h-[500px] overflow-hidden">
        <div className="absolute inset-0 bg-black/70">
          <video autoPlay muted loop playsInline className="w-full h-full object-cover mix-blend-overlay">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              <div className="rounded-full overflow-hidden aspect-square border-8 border-[#F8B712] shadow-xl bg-white">
                <img src="/images/launch event.jpg" alt="Mission" className="w-full h-full object-cover hover:scale-105 transition-transform duration-300"/>
              </div>
              <div className="absolute -bottom-8 -left-4 w-52 h-52 rounded-full overflow-hidden border-8 border-[#F8B712] shadow-lg bg-white">
                <img src="/images/Happy fellows.jpg" alt="Mission Detail" className="w-full h-full object-cover"/>
              </div>
            </div>
            <div>
              ...
              <div className="flex gap-8">
                {["Knowledge Sharing", "Mentorship", "Collaboration and Networking"].map((principle, index) => (<div key={index} className="flex items-center gap-2">
        ...
        <section className="py-8 relative">
          <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="relative">
              ...
              <img src="/images/form.jpg" alt="Purpose" className="rounded-lg shadow-xl relative z-10"/>
            </div>
            <div>
            ...
            },
            {
                ...
                color: "#D8D413"
        ...
        ].map((item, index, arr) => (<div key={index} className="relative">
                    ...
                    {index < arr.length - 1 && (<div className="absolute left-3 top-8 bottom-0 border-l-2 border-dotted border-black opacity-20 h-12"></div>)}
                  </div>))}
              </div>
            </div>
          </div>
        ...
        <section className="py-8 relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            },
            {
        ...
        ].map((project, index) => (<AlumniCard key={index} className="bg-[#045f3c] text-white p-8 rounded-xl transform hover:scale-105 transition-transform group">
                ...
                {index < 2 && (<div className="absolute left-1/2 -bottom-8 transform -translate-x-1/2 border-l-2 border-dotted border-[#045f3c] opacity-20 h-8"></div>)}
              </AlumniCard>))}
          </div>
                ...
                image: "/images/Sustainable Land Use Fellows.jpg"
        ...
        ].map((event, index) => (<Link key={index} href={`/programs/one-event/${event.id}`} className="block transform hover:scale-105 transition-transform duration-300">
                  <AlumniCard className="overflow-hidden border-2 border-[#045f3c] group cursor-pointer h-full">
                    <div className="relative h-48">
                      ...
                      <Button size="icon" className="absolute bottom-3 right-3 rounded-full bg-[#F8B712] hover:bg-[#045f3c] hover:text-white w-10 h-10 transition-colors duration-300">
