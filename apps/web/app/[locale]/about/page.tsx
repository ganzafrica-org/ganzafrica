...
const FloatingTag: FC<FloatingTagProps> = ({ text, position, color, rotate = "0deg" }) => (
  <div
...
const PromiseCard: FC<PromiseCardProps> = ({ type, items, content, hasCurvedCorner = false }) => {
  const bgColor = type === "partners" ? "bg-yellow-50" : "bg-green-800";
  const labelColor = type === "partners" ? "bg-yellow-400" : "bg-green-500";
      ...
      <section className="relative bg-green-900 text-white py-24">
        ...
        <div className="container mx-auto px-4 relative z-10">
          <h1 className="text-4xl md:text-5xl font-bold mb-4">
            {dict?.about?.hero?.title_1 || "Empowering"} <span className="text-white">{dict?.about?.hero?.title_2 || "Africa's Future"}</span>
          </h1>
      ...
      <section className="py-12 bg-white">
        <div className="container mx-auto px-4">
          <div className="flex justify-center mb-8">
            <DecoratedHeading
              firstText={dict?.about?.transformative_partner?.heading_first || "A Transformative"}
              secondText={dict?.about?.transformative_partner?.heading_second || "Partner"}
            />
          </div>
          ...
          <div className="relative inline-block">
            <div className="flex justify-center">
              <DecoratedHeading 
                ...
                secondText={dict?.about?.aspirations?.heading_second || "Aspirations"} 
              />
            </div>
          </div>
        </div>
          ...
          <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto">
            ...
            <div className="md:w-1/2 flex flex-col space-y-8">
              <MissionCard
                ...
                content={dict?.about?.aspirations?.mission_1 || "To advance a prosperous and sustainable food systems transformation in Africa through locally driven, system-focused solutions"}
              />
              ...
              <MissionCard
                ...
                label={dict?.about?.aspirations?.mission_label || "Our Mission"}
                content={dict?.about?.aspirations?.mission_2 || "To strengthen institutions, and the individuals who will shape and lead them, by equipping and placing youth with data-driven, systems-focused skills for improving food systems."}
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row gap-8 max-w-7xl mx-auto">
            <ValueCard
              ...
              description={dict?.about?.values?.evidence_description || "In-depth research and data-driven insights shape the solutions we co-create, leveraging local knowledge and building analytical expertise to ensure the best possible outcomes."}
            />
            ...
            <ValueCard
              ...
              textColor="text-white"
              description={dict?.about?.values?.integrity_description || "We work with authenticity and transparency. We are collaborative but not subject to influence or partiality."}
            />
            ...
            <ValueCard
              ...
              titleColor="text-yellow-400"
              description={dict?.about?.values?.stewardship_description || "We pattern the highest respect for human, financial, and natural resources and diligence in their utilization. The solutions we co-create enshrine this, alongside equality of access to resources now and for the future."}
            />
          </div>
        </div>
      </section>
      ...
      <section className="py-16 bg-white relative overflow-hidden">
        ...
        <div className="container mx-auto px-4 mb-8">
          <h2 className="text-4xl font-bold text-center">
            <span className="text-green-800">{dict?.about?.building_solutions?.heading_1 || "Building Sustainable "}</span>
            <span className="text-yellow-400">{dict?.about?.building_solutions?.heading_2 || "Solutions With"}</span>
            <br />
            <span className="text-yellow-400">{dict?.about?.building_solutions?.heading_3 || "African Communities!"}</span>
          </h2>
        </div>
      ...
      <section className="py-16 bg-white">
        ...
        <div className="flex flex-col md:flex-row gap-6 p-4 max-w-6xl mx-auto">
          ...
          <div className="md:w-1/2 flex flex-col space-y-6">
            <PromiseCard
              type="partners"
              items={dict?.about?.promise?.partners_items || [
            ...
            <PromiseCard
              type="fellows"
              content={dict?.about?.promise?.fellows_items || [
