...
const mockNotifications: Notification[] = [
  ...
  },
  {
    ...
    message: "Tech Career Fair 2025 is happening next week",
    time: "1 day ago",
    isRead: false,
    type: "event",
    priority: "high"
      ...
      <div className="flex items-center space-x-2">
        <div className="relative" ref={notificationsRef}>
          ...
          >
            ...
            {unreadCount > 0 && (
              <span className="absolute -top-1 -right-1 min-w-[20px] h-5 bg-[#045F3C] text-white text-xs font-medium px-1.5 flex items-center justify-center rounded-full ring-2 ring-white dark:ring-gray-800">
                {unreadCount}
              </span>
            )}
          </button>
          ...
          {isNotificationsOpen && (
            <div className="absolute right-0 mt-2 w-96 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 z-50 border border-gray-100 dark:border-gray-700">
              <div className="px-4 py-2 border-b border-gray-100 dark:border-gray-700 flex items-center justify-between">
                ...
                <Link
                  href="/notifications"
                  className="text-sm text-[#045F3C] hover:text-green-700 dark:text-green-400 dark:hover:text-green-300"
                >
                  View All
                </Link>
              </div>
              ...
              {notifications.length > 0 && (
                <div className="px-4 py-2 border-t border-gray-100 dark:border-gray-700">
                  <Link
                    href="/notifications"
                    className="text-sm text-center block w-full text-[#045F3C] hover:text-green-700 dark:text-green-400 dark:hover:text-green-300"
                  >
        ...
        {user ? (
          <div className="relative" ref={dropdownRef}>
            ...
            >
              <div className="relative w-8 h-8 rounded-full overflow-hidden bg-[#045F3C] text-white flex items-center justify-center">
              ...
              <div className="absolute right-0 mt-2 w-64 bg-white dark:bg-gray-800 rounded-lg shadow-lg py-2 z-50 border border-gray-100 dark:border-gray-700">
                <div className="px-4 py-3 border-b border-gray-100 dark:border-gray-700">
                  <div className="flex items-center space-x-3">
                    <div className="relative w-10 h-10 rounded-full overflow-hidden bg-[#045F3C] text-white flex items-center justify-center">
                      <span className="text-sm font-medium">{getInitials()}</span>
                    </div>
                    <div>
                ...
                <div className="py-1">
                  <Link href="/profile" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-[#045F3C] hover:text-white group mx-2 rounded-lg transition-colors">
                    <User className="w-4 h-4 mr-3 text-gray-400 dark:text-gray-500 group-hover:text-white" />
                    Profile
                  </Link>
                  <Link href="/settings" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-[#045F3C] hover:text-white group mx-2 rounded-lg transition-colors">
                ...
                <div className="py-1 border-t border-gray-100 dark:border-gray-700">
                  <Link href="/help" className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-[#045F3C] hover:text-white group mx-2 rounded-lg transition-colors">
                ...
                <div className="py-1 border-t border-gray-100 dark:border-gray-700">
                  <button
                    ...
                    className="flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-[#045F3C] hover:text-white group mx-2 rounded-lg transition-colors w-full text-left"
                  >
