...
const events = [
  {
    id: 1,
    title: "Meeting with the IT team...",
    time: "08:00 - 10:00",
    type: "On-site",
  ...
  {
    id: 5,
    title: "Uzuli presentation review",
    time: "08:00 - 10:00",
    type: "On-site",
    date: new Date(2025, 0, 10),
    color: "bg-purple-300",
  ...
  {
    id: 6,
    title: "Submition of P&Q Ltd reports",
    time: "09:00 - 10:00",
    type: "Home office",
  ...
  {
    id: 7,
    title: "Skillbuilder checkup with Doris",
    time: "08:00 - 10:00",
    type: "On-site",
          ...
          <div className="space-y-4 flex-1 overflow-auto dark:bg-slate-950">
            <div className="space-y-2">
              ...
              {[1, 2, 3, 4, 5, 6].map((i) => (
                <div
                  key={i}
                  className="flex items-center justify-between px-2 py-1.5 hover:bg-slate-50 dark:hover:bg-white/5 rounded-lg cursor-pointer group"
                >
                  <div className="flex items-center gap-3">
                    <div
                      className={cn(
                        ...
                        i % 2 === 0
                          ? "bg-purple-400 border-purple-100"
        ...
        <Card className="w-[50%] flex-1 border-slate-200 shadow-sm flex flex-col overflow-hidden dark:border-slate-800 dark:bg-slate-950 rounded-lg">
          <div className="p-4 border-b border-slate-100 flex items-center justify-between bg-white dark:bg-slate-900 dark:border-slate-800">
            ...
            <div className="bg-slate-100 p-1 rounded-lg flex gap-1 dark:bg-slate-800">
              <Button variant="ghost" size="sm" className="text-xs px-4 h-7">
                List view
              </Button>
              <Button
                variant="secondary"
                size="sm"
                className="text-xs px-4 h-7 bg-white shadow-sm font-bold dark:bg-slate-900 dark:shadow-none"
              >
                Month
              </Button>
              <Button variant="ghost" size="sm" className="text-xs px-4 h-7">
            ...
            <div className="grid grid-cols-7 border-b border-slate-100 dark:border-slate-800">
              {["Monday", "Tuesday", "Wednesday", "Thursday", "Friday", "Saturday", "Sunday"].map(
                (day) => (
                  <div
                    key={day}
                    className="py-2 text-center text-xs font-bold text-slate-400 border-r border-slate-100 last:border-r-0 dark:text-slate-300 dark:border-slate-800"
                  >
                    {day}
                  </div>
                ),
                ...
                return (
                  ...
                  >
                    <span
                      className={cn(
                        "text-xs font-bold",
                        displayDay === 9 && isCurrentMonth
                          ? "bg-brand-accent text-white w-6 h-6 flex items-center justify-center rounded-full"
                    ...
                    <div className="mt-2 space-y-1">
                      {cellEvents.map((event) => (
                        ...
                        >
                          ...
                          <p className="opacity-80 text-[8px]">
