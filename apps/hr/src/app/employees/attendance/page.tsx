        ...
        <div className="w-full flex justify-center items-center p-6 bg-transparent">
            <div className="flex flex-col space-y-6 mx-auto w-[80%]">
                <div className="flex flex-row items-center justify-between">
                    <h1 className="text-2xl font-bold bg-blue-secondary bg-clip-text text-transparent">Attendance Management</h1>
                    <div className="flex flex-row gap-2">
                        ...
                        <Button><Timer className="h-4 w-4" /> Bulk Check-in</Button>
                    </div>
                </div>
                ...
                <Tabs defaultValue="daily" className="flex flex-col gap-5 w-full">
                    <TabsList className="bg-white shadow-sm border w-full flex flex-row">
                        ...
                        <TabsTrigger value="events" className="flex-1 data-[state=active]:bg-blue-500 data-[state=active]:text-white">
                            <UserCheck className="h-4 w-4 mr-2" /> Event Attendance
                        </TabsTrigger>
                        <TabsTrigger value="analytics" className="flex-1 data-[state=active]:bg-amber-500 data-[state=active]:text-white">
                            <TrendingUp className="h-4 w-4 mr-2" /> Analytics
                        </TabsTrigger>
                        <TabsTrigger value="approvals" className="flex-1 data-[state=active]:bg-purple-500 data-[state=active]:text-white">
                    ...
                    <TabsContent value="daily" className="flex flex-col space-y-6">
                        <AttendanceSearch
                            ...
                            attendanceTypeFilter={attendanceTypeFilter} setAttendanceTypeFilter={setAttendanceTypeFilter}
