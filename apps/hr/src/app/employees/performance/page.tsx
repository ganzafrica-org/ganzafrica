        ...
        <div className="w-full flex justify-center p-6 bg-transparent">
            <div className="flex flex-col space-y-6 w-[80%]">
                <div className="flex flex-row items-center justify-between">
                    <h1 className="text-2xl font-bold bg-blue-secondary bg-clip-text text-transparent">Performance Management</h1>
                    <div className="flex flex-row gap-2">
                        ...
                        <Button><Plus className="h-4 w-4" /> New Review Cycle</Button>
                    </div>
                </div>
                ...
                <Tabs defaultValue="reviews" className="flex flex-col gap-10 w-full">
                    <TabsList className="bg-white shadow-sm border w-full flex flex-row">
                        <TabsTrigger value="reviews" className="flex-1 data-[state=active]:bg-green-500 data-[state=active]:text-white">
                            <CheckCircle className="h-4 w-4 mr-2" /> Performance Reviews
                        </TabsTrigger>
                        <TabsTrigger value="okrs" className="flex-1 data-[state=active]:bg-blue-500 data-[state=active]:text-white">
                            <Target className="h-4 w-4 mr-2" /> OKRs & Goals
                        </TabsTrigger>
                        <TabsTrigger value="feedback" className="flex-1 data-[state=active]:bg-amber-500 data-[state=active]:text-white">
                            <MessageSquare className="h-4 w-4 mr-2" /> 360° Feedback
                        </TabsTrigger>
                        <TabsTrigger value="analytics" className="flex-1 data-[state=active]:bg-purple-500 data-[state=active]:text-white">
                    ...
                    <TabsContent value="reviews" className="flex flex-col space-y-6">
                        ...
                        <PerformanceTable
                            ...
                            onConductReview={(emp) => { setSelectedEmployee(emp); setShowReviewDialog(true); }}
                        />
                    </TabsContent>
