  ...
  return (
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        ...
        <Button variant="link" className="text-orange-500 font-bold gap-1">
                ...
                <Badge
                  className={
                    person.status === "Offer sent"
                      ? "bg-blue-50 text-blue-500 border-none shadow-none font-bold"
                      : person.status === "Task Test"
                        ? "bg-orange-50 text-orange-400 border-none shadow-none font-bold"
