  ...
  return (
    <TooltipPrimitive.Portal>
      <TooltipPrimitive.Content
        ...
        className={cn(
          // z-[150] on the content: same tier as dialog.tsx. The **:data-[slot=kbd]:z-50 further
          // down is an internal layer (kbd glyph inside the tooltip box), unrelated to
          // page-level stacking — left as-is.
