  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          // z-[150]: must stay level with dialog.tsx/popover.tsx/dropdown-menu.tsx/sheet.tsx —
          // this is the tier that renders above ReusableSheet (z-[100]/z-[101]); keeping it
          // equal to Dialog's z-index preserves correct portal-order nesting when a Select is
          // opened from within a Dialog.
