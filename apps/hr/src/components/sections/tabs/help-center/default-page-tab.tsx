...
const TOPICS = [
  {
    ...
    desc: "CallRail makes call tracking simple and easy. Learn how to set up your account and configure your first tracking number.",
  },
  {
    title: "Call Tracking",
    desc: "Learn how you can get a CallRail number and start tracking calls and marketing campaigns instantly.",
  },
  {
    title: "Form Tracking",
    desc: "Track the forms your customers submit on your website and get alerted when you have a new form submission.",
  },
  {
    title: "Conversation Intelligence",
    desc: "Conversation Intelligence transcribes your calls, then uses AI to analyze them for actionable insights.",
  },
  {
    title: "Lead Center",
    desc: "Lead Center is a lead management system that provides a single, unified inbox for all your interactions.",
  },
  {
    title: "Google Integrations",
    desc: "Our full set of Google integrations help you get more from your calls and find the data that matters most.",
  },
  {
    title: "Integrations",
    desc: "Learn how to integrate your data with a range of marketing and communication tools for even deeper insights.",
  },
  {
    title: "Reports",
    desc: "Reports allow you to analyze call data by source, keyword, day, and more. You can also export and share your reports.",
  },
  {
    title: "API & Webhooks",
    desc: "Our API and Webhook documentation provides everything you need to modify data in your account programmatically.",
  },
  {
    title: "Account Management",
    desc: "Configure a range of account, company, and user settings to fine-tune your experience.",
  },
  {
    title: "Security & Data Privacy",
    desc: "Learn about common aspects of our security and data privacy policies as they pertain to your account.",
  },
  {
    title: "Agency Tools",
    desc: "Add your company's branding with our White Label feature, create custom pricing plans, and more.",
  },
];
...
const CATEGORIES = [
  {
    icon: "📞",
    label: "Call Tracking",
    sub: "Getting started with Call Tracking",
    color: "#ddeeff",
  },
  { icon: "📥", label: "Lead Center", sub: "Getting started with Lead Center", color: "#ddf5ea" },
  {
    icon: "📋",
    label: "Form Tracking",
    sub: "Getting started with Form Tracking",
    color: "#fff3d4",
  },
  {
    icon: "🧠",
    label: "Conversation Intelligence",
    sub: "Getting started with CI",
    color: "#eeecff",
  },
];
...
export default function HelpCenter() {
  ...
  const [chatMessages, setChatMessages] = useState<ChatMessage[]>([
    {
      role: "bot",
      text: "Hi there! 👋 I'm your AI assistant. Ask me anything about call tracking, integrations, account setup, or any other feature!",
    },
  ]);
    ...
    try {
      const res = await fetch("https://api.anthropic.com/v1/messages", {
        ...
        body: JSON.stringify({
          ...
          max_tokens: 1000,
          system:
            "You are a friendly and knowledgeable AI assistant for a call tracking and analytics help center. Help users with Call Tracking, Lead Center, Form Tracking, Conversation Intelligence, Integrations, Reports, API & Webhooks, Account Management, Security, and Agency Tools. Be concise, helpful, and friendly.",
          messages: msgs,
        }),
      });
      const data = await res.json();
      const reply: string =
        data.content?.[0]?.text ?? "Sorry, I had trouble responding. Please try again.";
  ...
  return (
    <>
        ...
        >
          ...
          >
            <svg width="16" height="16" viewBox="0 0 16 16" fill="#fff">
              <path d="M3 8a5 5 0 0110 0A5 5 0 013 8zm5-3a1 1 0 000 2h.01a1 1 0 100-2H8zm0 4a1 1 0 100 2 1 1 0 000-2z" />
            </svg>
          </div>
          TrackAI
        </a>
      ...
      <div
        style={{
          background: "linear-gradient(135deg,#1a2744 0%,#1e4db7 60%,#1e6eff 100%)",
      ...
      >
        ...
        <p style={{ color: "rgba(255,255,255,0.65)", fontSize: 13, position: "relative" }}>
          ...
          {["lead center", "call tracking", "integrations"].map((t) => (
            <span key={t} className="popular-link" onClick={() => setSearchVal(t)}>
              {t}
            </span>
          ))}
        </p>
      ...
      >
        {CATEGORIES.map((c) => (
          <a key={c.label} href="#" className="cat-item">
            ...
            <span style={{ fontWeight: 600, fontSize: 13, textAlign: "center", color: "#1a1a1a" }}>
              {c.label}
            </span>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1.25rem" }}>
          {TOPICS.map((t) => (
            <div key={t.title} className="topic-card">
              <div
                style={{ fontWeight: 600, fontSize: 14, color: "#1e6eff", marginBottom: "0.5rem" }}
              >
                {t.title}
              </div>
      ...
      <button
        ...
        style={{
          background: chatOpen ? "#1a2744" : "#1e6eff",
          color: "#fff",
          boxShadow: chatOpen
            ? "0 6px 20px rgba(26,39,68,0.35)"
            : "0 6px 20px rgba(30,110,255,0.35)",
        }}
      ...
      >
        ...
        <div
          style={{
            background: "linear-gradient(135deg,#1a2744,#1e6eff)",
            color: "#fff",
