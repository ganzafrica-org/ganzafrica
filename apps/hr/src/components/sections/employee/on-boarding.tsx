...
//
//
//     const convertToKanbanItems = (data: typeof onboardingData): any[] => {
...
//     }
//
//     const [kanbanData, setKanbanData] = useState<any[]>(convertToKanbanItems(onboardingDataState))
//
//     React.useEffect(() => {
...
//
//     return (
//         <div className="space-y-8 min-h-screen p-6 bg-transparent">
//
//
