...
export const PerformanceDetailDialog = ({ employee, open, onOpenChange, onConductReview }: PerformanceDetailDialogProps) => {
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="h-[300px]">
                            <ResponsiveContainer width="100%" height="100%">
                                <RadarChart data={Object.entries(employee.competencies).map(([key, value]) => ({
