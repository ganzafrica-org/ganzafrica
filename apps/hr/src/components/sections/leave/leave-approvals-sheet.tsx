...
interface LeaveApprovalsSheetProps {
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

/**
 * Leave approvals as a sheet (was a standalone /leave/approvals route) — opened from the
 * Time Off page so managers/HR can act on pending requests without leaving the page.
 */
export function LeaveApprovalsSheet({ open, onOpenChange }: LeaveApprovalsSheetProps) {
  ...
  return (
    <ReusableSheet
      ...
      description="Requests from people who report to you. HR sees every pending request."
