...
export const DepartmentSheet = ({
    ...
    const inactive = selectedDepartment.count - selectedDepartment.active - selectedDepartment.onLeave
                ...
                <div className="p-6 border-b space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                        <Avatar className="h-16 w-16 border-2 border-white shadow-md">
                            <AvatarFallback className={`text-xl font-bold ${deptColors[selectedDepartment.name] ?? "bg-slate-100 text-slate-600"}`}>
                ...
                <div className="flex-1 overflow-y-auto p-6 space-y-8">
                        ...
                        {isEditing && editForm ? (
                            <div className="grid grid-cols-2 gap-x-8 gap-y-4">
                                <div className="space-y-2">
                                    <Label htmlFor="edit-name" className="text-[10px] uppercase font-bold text-slate-400">
                                        Department Name
                                    </Label>
                                    <Input
                                        id="edit-name"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="edit-count" className="text-[10px] uppercase font-bold text-slate-400">
                                        Total Employees
                                    </Label>
                                    <Input
                                        id="edit-count"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="edit-active" className="text-[10px] uppercase font-bold text-slate-400">
                                        Active
                                    </Label>
                                    <Input
                                        id="edit-active"
                                ...
                                <div className="space-y-2">
                                    <Label htmlFor="edit-onleave" className="text-[10px] uppercase font-bold text-slate-400">
                                        On Leave
                                    </Label>
                                    <Input
                                        id="edit-onleave"
                            ...
                            <div className="grid grid-cols-2 gap-x-8 gap-y-6">
                                <div className="space-y-1">
                                    <div className="text-[10px] uppercase font-bold text-slate-400">Department Name</div>
                                    <div className="text-sm font-medium text-slate-900">{selectedDepartment.name}</div>
                                </div>
                                <div className="space-y-1">
                                    <div className="text-[10px] uppercase font-bold text-slate-400">Total Employees</div>
                                    <div className="text-sm font-medium text-slate-900">{selectedDepartment.count}</div>
                                </div>
                                <div className="space-y-1">
                                    <div className="text-[10px] uppercase font-bold text-slate-400">Active</div>
                                    <div className="text-sm font-medium text-slate-900">{selectedDepartment.active}</div>
                                </div>
                                <div className="space-y-1">
                                    <div className="text-[10px] uppercase font-bold text-slate-400">On Leave</div>
                                    <div className="text-sm font-medium text-slate-900">{selectedDepartment.onLeave}</div>
                                </div>
                                <div className="space-y-1">
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="space-y-1">
                                <div className="flex justify-between text-xs text-slate-500">
                                    <span>Active</span>
                                    <span>{selectedDepartment.count > 0
                                ...
                                <div className="h-2 rounded-full bg-slate-100 overflow-hidden">
                                    <div
                                        ...
                                        style={{ width: `${selectedDepartment.count > 0
                    ...
                    <div className="space-y-4">
                        ...
                        <div className="flex flex-wrap gap-2">
                            <Badge variant="secondary" className="bg-green-100 text-green-700 border-none font-normal text-xs px-3 py-1">
                                {selectedDepartment.active} Active
                            </Badge>
                            <Badge variant="secondary" className="bg-amber-100 text-amber-700 border-none font-normal text-xs px-3 py-1">
                                {selectedDepartment.onLeave} On Leave
                            </Badge>
                            {inactive > 0 && (
                                <Badge variant="secondary" className="bg-red-100 text-red-700 border-none font-normal text-xs px-3 py-1">
                                    {inactive} Inactive
                                </Badge>
                            )}
                        </div>
