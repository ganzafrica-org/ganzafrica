...
export const AddEmployeeSheet=({ open, onOpenChange }: AddEmployeeSheetProps)=> {
    const [currentStep, setCurrentStep] = useState<StepType>('dealType')
    ...
    const handleSubmit = async () => {
        // TODO: call your useCreateEmployee mutation here
        // e.g. await createMutation.mutateAsync({ ...formData })
        onOpenChange(false)
    }
            ...
            <div className="w-full max-w-[95%] h-[calc(100vh-2rem)] flex flex-col overflow-hidden">
                                    ...
                                    <div className="space-y-6 p-6 overflow-y-auto">
                                            ...
                                            {(['indefinite', 'definite'] as const).map(term => (
                                                <label key={term}
                                                       className={`flex items-center gap-3 p-3 rounded-lg border-2 cursor-pointer transition-all ${
                                                           formData.employmentTerm === term ? 'border-brand-accent bg-brand-accent/5' : 'border-gray-200'
                                                       }`}>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {(['full-time', 'part-time'] as const).map(type => (
                                                <label key={type}
                                                       className={`flex items-center gap-3 p-3 rounded-lg border-2 cursor-pointer transition-all ${
                                                           formData.employmentType === type ? 'border-brand-accent bg-brand-accent/5' : 'border-gray-200'
                                                       }`}>
                                        ...
                                        <div className="space-y-3">
                                            ...
                                            {(['upload', 'skip'] as const).map(opt => (
                                                <label key={opt}
                                                       className={`flex items-center gap-3 p-3 rounded-lg border-2 cursor-pointer transition-all ${
                                                           formData.employmentAgreement === opt ? 'border-brand-accent bg-brand-accent/5' : 'border-gray-200'
                                                       }`}>
                ...
                <div className="md:hidden p-6 space-y-6">
                    ...
                    <AnimatePresence mode="wait">
                        ...
                        >
                            {/* Same content as desktop - reuse the rendering logic */}
                            {currentStep === 'dealType' && (
                            ...
                            {currentStep === 'dealDetails' && (
                                <div className="space-y-5">
                                    ...
                                    <div>
                                        <Label htmlFor="mobile-dealTitle" className="text-sm">
                                            Deal Title
                                        </Label>
                                        <Input
                                            id="mobile-dealTitle"
                                    ...
                                    <div>
                                        <Label htmlFor="mobile-dealCode" className="text-sm">
                                            Deal Code
                                        </Label>
                                        <Input
                                            id="mobile-dealCode"
                                    ...
                                    <div>
                                        ...
                                        >
                                            <SelectTrigger id="mobile-offeredItems" className="mt-2">
                            ...
                            {currentStep === 'dealUsage' && (
                                <div className="space-y-4">
                                    <h2 className="text-xl font-bold text-gray-900">
                                        Deal Usage
                                    </h2>
                                    <p className="text-sm text-gray-600">
                                        Set limitations and special offers
                                    </p>
                                    <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
                                        <p>
                                            <strong>Type:</strong> {formData.dealType}
                                        </p>
                                        <p>
                                            <strong>Title:</strong> {formData.dealTitle}
                                        </p>
                                        <p>
                                            <strong>Code:</strong> {formData.dealCode}
                                        </p>
                                    </div>
                                </div>
                            )}

                            {currentStep === 'reviewComplete' && (
                                <div className="space-y-4">
                                    <h2 className="text-xl font-bold text-gray-900">
                                        Review & Launch
                                    </h2>
                                    <div className="bg-gray-50 p-4 rounded-lg space-y-2 text-sm">
                                        <p>
                                            <strong>Deal Type:</strong> {formData.dealType}
                                        </p>
                                        <p>
                                            <strong>Title:</strong> {formData.dealTitle}
                                        </p>
