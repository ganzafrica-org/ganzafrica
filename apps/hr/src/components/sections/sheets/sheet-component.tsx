      ...
      {open && (
        <>
          ...
          <motion.div
            ...
            className={cn(
              "fixed bg-white shadow-2xl z-[101] flex flex-col overflow-hidden",
          ...
          >
            <div className="flex-1 flex flex-col h-full relative">
              ...
              <button
                onClick={() => onOpenChange(false)}
                className="absolute right-4 top-4 text-gray-500 hover:text-gray-700 p-2 rounded-full hover:bg-gray-100 transition-colors z-10"
              >
                <X size={20} />
              </button>
              ...
              {(title || description) && (
                <div className="p-6 border-b shrink-0">
                  {title && <h2 className="font-bold text-brand-dark pr-8">{title}</h2>}
              ...
              {footer && <div className="p-4 border-t bg-slate-50/50 mt-0 shrink-0">{footer}</div>}
            </div>
          </motion.div>
        </>
      )}
