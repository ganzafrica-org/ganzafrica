                ...
                return (
                  <div key={step.id}>
                    ...
                    <motion.div
                      ...
                      className={`flex items-start gap-4 cursor-pointer transition-opacity ${
                  ...
                  <div className="space-y-5 p-6">
                    ...
                    <div className="space-y-1.5">
                      ...
                      <Input
                        ...
                        onChange={(e) =>
                          setFormData((p) => ({ ...p, citizenship: e.target.value }))
                        }
                      />
                    </div>
                    <div>
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div className="space-y-1.5">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData((p) => ({ ...p, homeCountry: e.target.value }))
                            }
                          />
                        </div>
                        <div className="space-y-1.5">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData((p) => ({ ...p, homeCity: e.target.value }))
                            }
                          />
                        </div>
                      </div>
                      ...
                      {formData.employmentTerm === "definite" && (
                        <div className="space-y-1.5 pl-1">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData((p) => ({ ...p, contractEndDate: e.target.value }))
                            }
                          />
                        </div>
                      )}
                      ...
                      {formData.employmentType === "part-time" && (
                        <div className="space-y-1.5 pl-1">
                          ...
                          <Input
                            ...
                            onChange={(e) =>
                              setFormData((p) => ({ ...p, daysPerWeek: e.target.value }))
                            }
                          />
                        </div>
                      )}
                      ...
                      {formData.compensationType === "salaried" && (
                        <div className="space-y-1.5">
                          ...
                          <Select
                            ...
                            onValueChange={(v) =>
                              setFormData((p) => ({ ...p, salaryScale: v as any }))
                            }
                          >
                            <SelectTrigger>
                    ...
                    <div className="space-y-3">
                      ...
                      {(["upload", "skip"] as const).map((opt) => (
                        <label
                          key={opt}
                          className={`flex items-center gap-3 p-3 rounded-lg border-2 cursor-pointer transition-all ${
                            formData.employmentAgreement === opt
                              ? "border-brand-accent bg-brand-accent/5"
                              : "border-gray-200"
                          }`}
                        >
                          <input
                            ...
                            onChange={() =>
                              setFormData((p) => ({ ...p, employmentAgreement: opt }))
                            }
                            className="accent-brand-accent"
                          />
                          <span className="text-sm font-medium">
                            {opt === "upload"
                              ? "Upload an employment agreement for now"
                              : "Don't add an employment agreement for now"}
                          </span>
                        </label>
                      ))}
                      {formData.employmentAgreement === "upload" && (
                        <div className="mt-2 space-y-1.5">
                          ...
                          <p className="text-xs text-gray-500">
                            You can upload either a signed or unsigned version.
                          </p>
                ...
                {currentStep === "reviewCreate" && (
                  <div className="space-y-5 p-6">
                    <div>
                      ...
                      <p className="text-sm text-gray-500 mt-1">
                        Check everything before creating the employee
                      </p>
                    </div>
                    ...
                    {[
                      {
                        ...
                        rows: [
                          ...
                          [
                            "Home Address",
                            [formData.homeCity, formData.homeCountry].filter(Boolean).join(", ") ||
                              "—",
                          ],
                        ],
                      },
                      ...
                      },
                      {
                        ...
                        rows: [
                          ...
                          ...(formData.employmentTerm === "definite"
                            ? [
                                ["Contract End Date", formData.contractEndDate || "—"] as [
                                  string,
                                  string,
                                ],
                              ]
                          ...
                          ...(formData.employmentType === "part-time"
                            ? [["Days/Week", formData.daysPerWeek || "—"] as [string, string]]
                            : []),
                          ["Compensation", formData.compensationType || "—"],
                          ["Currency", formData.currency || "—"],
                          [
                            "Base Monthly Rate",
                            formData.baseMonthlyRate
                              ? `${formData.currency} ${formData.baseMonthlyRate}`
                              : "—",
                          ],
                          [
                            "Gross Annual Rate",
                            formData.grossAnnualRate
                              ? `${formData.currency} ${formData.grossAnnualRate}`
                              : "—",
                          ],
                          [
                            "Agreement",
                            formData.employmentAgreement === "upload"
                              ? "Will upload"
                              : formData.employmentAgreement === "skip"
                                ? "Skipped"
                                : "—",
                          ],
                        ],
                      ...
                      >
                        ...
                        {section.rows.map(([label, value]) => (
                          <div
                            key={label}
                            className="flex justify-between items-center px-4 py-2.5 border-b border-gray-50 last:border-0"
                          >
              ...
              {STEPS.map((step, index) => {
                ...
                return (
                  <div key={step.id} className="flex-1 flex flex-col items-center">
                    <motion.div
                      animate={{
                        backgroundColor: completed ? "#4F46E5" : active ? "#1F2937" : "#E5E7EB",
                      }}
                    ...
                    <p className="text-xs font-semibold text-center text-gray-900">{step.title}</p>
                  </div>
                );
              })}
            </div>
