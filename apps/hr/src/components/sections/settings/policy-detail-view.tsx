              ...
              <div className="flex items-start gap-3 p-4 bg-blue-50 rounded-lg border border-blue-100">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-600 mt-2">
                    Approvals for all worker types, except contractors, appear under &quot;Time
                    tracking submissions&quot; in the homepage. Contractor approvals appear in
                    &quot;Contractors&apos; submissions&quot; and are configured in{" "}
