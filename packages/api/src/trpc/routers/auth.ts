...
export const authRouter = router({
                ...
                if (user?.two_factor_enabled) {
                    ...
                    return {
                        ...
                        data: {
                            ...
                            twoFactorMethod: user.two_factor_method?.toString() || 'authenticator',
                            tempToken
                        }
                    };
                }
    ...
    logout: protectedProcedure
        .mutation(async ({ ctx }): Promise<AuthResponse> => {
            try {
    ...
    requestPasswordReset: publicProcedure
        ...
        .mutation(async ({ input, ctx }): Promise<AuthResponse> => {
            try {
                ...
                logger.error('Password reset request error', { error, email: input.email });
    ...
    setupTwoFactor: protectedProcedure
        .mutation(async ({ ctx }): Promise<AuthResponse<{
            ...
            try {
                ...
                throw new TRPCError({
                    code: 'INTERNAL_SERVER_ERROR',
                    message: 'An error occurred while setting up two-factor authentication. Please try again.',
                    cause: error,
                });
            }
        }),
    ...
    verifyTwoFactorSetup: protectedProcedure
        ...
        .mutation(async ({ ctx, input }): Promise<AuthResponse> => {
            try {
                ...
                throw new TRPCError({
                    code: 'INTERNAL_SERVER_ERROR',
                    message: 'An error occurred while verifying two-factor authentication. Please try again.',
                    cause: error,
                });
            }
        }),
