...
CREATE TYPE "public"."base_role" AS ENUM('public', 'applicant', 'fellow', 'employee', 'alumni');--> statement-breakpoint
...
CREATE TYPE "public"."job_posting_type" AS ENUM('fellowship', 'employment');--> statement-breakpoint
...
CREATE TYPE "public"."milestone_status" AS ENUM('pending', 'in_progress', 'completed', 'failed');--> statement-breakpoint
CREATE TYPE "public"."posting_status" AS ENUM('draft', 'published', 'closed');--> statement-breakpoint
CREATE TYPE "public"."project_member_role" AS ENUM('lead', 'member', 'supervisor');--> statement-breakpoint
...
CREATE TABLE "job_postings" (
	...
	"type" "job_posting_type" NOT NULL,
...
ALTER TABLE "reporting_lines" ADD CONSTRAINT "reporting_lines_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "reporting_lines" ADD CONSTRAINT "reporting_lines_reports_to_id_users_id_fk" FOREIGN KEY ("reports_to_id") REFERENCES "public"."users"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
