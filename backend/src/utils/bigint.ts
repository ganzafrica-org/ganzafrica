 ...
 */
export function toDbId(id: string | number | bigint | undefined | null): string | undefined {
 ...
 */
export function toApiId(id: string | number | bigint | null | undefined): string | null {
