...
router.patch("/:id/answer", validate(helpdeskValidation.answerTicketSchema), helpdeskController.answerTicket);
router.patch("/:id", validate(helpdeskValidation.updateTicketSchema), helpdeskController.updateTicket);
router.delete("/:id", validate(helpdeskValidation.ticketIdParamSchema), helpdeskController.deleteTicket);
