...
export const createFellowshipSchema = z.object({
  body: baseOpportunitySchema.merge(
    z.object({
...
export const updateFellowshipSchema = z.object({
  params: idParamsSchema,
  body: baseOpportunitySchema.partial().merge(
    z.object({
...
export const generalApplicationSchema = z.object({
  body: z.object({
    ...
    national_strategy: z
      .string()
      .min(10, "National strategy contribution must be at least 10 characters long"),

    // Programme Relevance
    how_ganzafrica_can_help: z.string().min(10, "This field must be at least 10 characters long"),
    contribution_to_ganzafrica: z
      .string()
      .min(10, "This field must be at least 10 characters long"),
